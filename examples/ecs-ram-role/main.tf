...
resource "alicloud_security_group_rule" "rules" {
  ...
  security_group_id = "${var.sg_id == "" ? alicloud_security_group.group.id : var.sg_id}"
...
resource "alicloud_instance" "instances" {
  ...
  security_groups = ["${var.sg_id == "" ? alicloud_security_group.group.id : var.sg_id}"]
