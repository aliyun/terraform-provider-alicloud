...
| **与镇元相关且镇元 NOT OK**(资源未定义 / 属性不满足诉求 / 覆盖度<100%)——镇元侧根因主责,**无论紧急与否都建单**,原单也指派谜拟 | 谜拟 | 479782 |
| 同上且**紧急**(优先级=紧急 或 距 DDL<14 天 或 缺陷类型覆写):在谜拟单之外**再建一张关联单并行**(紧急兜底 provider 侧,两人都建) | 新山 | 521957 |
...
**与镇元不相关的问题**(2026-07-06 定义,谜拟不接这两类):
