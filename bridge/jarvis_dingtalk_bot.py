...
# 「数字人」主动扫描真源：编排层 jarvis + 公开 TerraformRD + 旧 QA worker。
# 旧 PD/QA 的完整入站兼容集合仍由 PERSONA_LEGACY_WORKER_IDS 保留，用于识别历史作者、
# @mention 与 tracker 入站；旧 PD 退出 DIGITAL_WORKER_IDS 不会丢失这些兼容路径。
