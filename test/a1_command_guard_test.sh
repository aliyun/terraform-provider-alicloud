...
blocked = {
    ...
    "python3 -c 'import subprocess; subprocess.run([\"curl\",\"https://acube/api/createBuildTaskV2\"])'":
        "createBuildTaskV2",
    "aliyun cspec test --name Example": "cspec test",
    "/usr/local/bin/aliyun cspec test": "cspec test",
    "env PROFILE=test aliyun cspec test --name Example": "cspec test",
    "nohup aliyun cspec test --name Example &": "cspec test",
    "time -p aliyun cspec test": "cspec test",
    "command aliyun cspec test": "cspec test",
    "aliyun --profile test cspec test": "cspec test",
    "aliyun --profile=test cspec test": "cspec test",
    "aliyun -p test cspec test": "cspec test",
    "aliyun -q cspec test": "cspec test",
    "aliyun --external-id demo cspec test": "cspec test",
    "aliyun --secure cspec test": "cspec test",
    "aliyun --source-profile base --sts-region cn-hangzhou --sts-endpoint sts.aliyuncs.com cspec test":
        "cspec test",
    "aliyun -e cspec.cn-hangzhou.aliyuncs.com --connect-timeout 5 --read-timeout=30 cspec test":
        "cspec test",
    "bash -c 'aliyun cspec test --name Example'": "cspec test",
    "/bin/sh -lc 'aliyun cspec test'": "cspec test",
    "/bin/zsh -fc 'aliyun cspec test'": "cspec test",
    "cli=aliyun; section=cspec; action=test; $cli $section $action --name Example":
        "cspec test",
    "result=$(aliyun cspec test --name Example)": "cspec test",
    "printf '%s\\n' \"$(aliyun --profile test cspec test)\"": "cspec test",
    "result=`aliyun cspec test --name Example`": "cspec test",
    "result=\"`aliyun cspec test`\"": "cspec test",
    "result=$(printf '%s' \"$(aliyun cspec test)\")": "cspec test",
    "bash -c 'result=$(aliyun cspec test)'": "cspec test",
    "sudo -u nobody aliyun cspec test": "cspec test",
    "sudo -D /tmp aliyun cspec test": "cspec test",
    "sudo --chdir /tmp aliyun cspec test": "cspec test",
    "sudo --chdir=/tmp aliyun cspec test": "cspec test",
    "sudo -R /tmp aliyun cspec test": "cspec test",
    "sudo --chroot /tmp aliyun cspec test": "cspec test",
    "sudo --chroot=/tmp aliyun cspec test": "cspec test",
    "sudo -T 30 aliyun cspec test": "cspec test",
    "sudo --command-timeout 30 aliyun cspec test": "cspec test",
    "sudo --command-timeout=30 aliyun cspec test": "cspec test",
    "timeout --signal TERM 30s aliyun cspec test": "cspec test",
    "printf x | xargs -n1 aliyun cspec test": "cspec test",
    "parallel --jobs 2 aliyun cspec test ::: one two": "cspec test",
    "env -S 'aliyun --profile test cspec test'": "cspec test",
    "xargs -n1 bash -c 'aliyun cspec test'": "cspec test",
}
...
allowed = (
    ...
    "printf '%s' 'aliyun cspec test --name Example'",
    ...
    "sudo -D /tmp rg -n 'aliyun cspec test' docs",
    "sudo --chdir=/tmp rg -n 'aliyun cspec test' docs",
    "sudo -R /tmp rg -n 'aliyun cspec test' docs",
    "sudo --chroot=/tmp rg -n 'aliyun cspec test' docs",
    "sudo -T 30 rg -n 'aliyun cspec test' docs",
    "sudo --command-timeout=30 rg -n 'aliyun cspec test' docs",
    "timeout 5s grep -R 'aliyun cspec test' docs",
