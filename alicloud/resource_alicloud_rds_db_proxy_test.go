...
func TestAccAliCloudRdsDBProxy_MySQL(t *testing.T) {
	...
	effectiveSpecificTime := time.Now().Add(-7*time.Hour - 25*time.Minute).Format("2006-01-02T15:04:05Z")
	switchTime := time.Now().Add(-7*time.Hour - 25*time.Minute).Format("2006-01-02T15:04:05Z")
