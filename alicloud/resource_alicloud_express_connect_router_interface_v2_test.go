...
// Case RouterInterface-InitiatingSide-PrePaid 11729
func TestAccAliCloudExpressConnectRouterInterface_basic11729(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_express_connect_router_interface_v2.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"auto_pay", "auto_renew", "delete_health_check_ip", "period", "pricing_cycle"},
			},
		},
	})
}
