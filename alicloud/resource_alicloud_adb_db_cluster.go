...
func resourceAlicloudAdbDbClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("payment_type"); ok {
		request["PayType"] = convertAlicloudAdbDbClusterDBClusterPaymentTypeRequest(v.(string))
...
func resourceAlicloudAdbDbClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.Set("payment_type", convertAlicloudAdbDbClusterDBClusterPaymentTypeResponse(object["PayType"].(string)))
	d.Set("pay_type", convertAlicloudAdbDbClusterDBClusterPaymentTypeResponse(object["PayType"].(string)))
...
func convertAlicloudAdbDbClusterDBClusterPaymentTypeRequest(source string) string {
	switch source {
	case "PostPaid":
		return "Postpaid"
	case "PrePaid":
...
func convertAlicloudAdbDbClusterDBClusterPaymentTypeResponse(source string) string {
	switch source {
	case "Postpaid":
		return "PostPaid"
	case "Prepaid":
