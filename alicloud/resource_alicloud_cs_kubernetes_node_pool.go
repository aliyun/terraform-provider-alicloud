	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"surge_percentage": {
							Type:       schema.TypeInt,
							Optional:   true,
							Deprecated: "Field 'surge_percentage' has been deprecated from provider version 1.215.0. Proportion of additional nodes. You have to specify one of surge, surge_percentage.",
						},
						"surge": {
							Type:       schema.TypeInt,
							Optional:   true,
							Deprecated: "Field 'surge' has been deprecated from provider version 1.215.0. Number of additional nodes. You have to specify one of surge, surge_percentage.",
						},
						"auto_vul_fix_policy": {
							Type:     schema.TypeList,
							Optional: true,
						...
						"max_unavailable": {
							Type:         schema.TypeInt,
							Optional:     true,
							Deprecated:   "Field 'max_unavailable' has been deprecated from provider version 1.215.0. Maximum number of unavailable nodes. Default value: 1. Value range:\\[1,1000\\]",
			...
			"platform": {
				...
				Optional:     true,
				Computed:     true,
				Deprecated:   "Field 'platform' has been deprecated from provider version 1.215.0. Operating system release. Default value: 'AliyunLinux '. Valid values: `CentOS`, `AliyunLinux`, `Windows`, `WindowsCore`.",
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"eip_bandwidth": {
							Type:         schema.TypeInt,
							Optional:     true,
							Deprecated:   "Field 'eip_bandwidth' has been deprecated from provider version 1.215.0. Peak EIP bandwidth. Its valid value range [1~500] in Mbps. Default to `5`.",
							ValidateFunc: IntBetween(0, 500),
						},
						"is_bond_eip": {
							Type:       schema.TypeBool,
							Optional:   true,
							Deprecated: "Field 'is_bond_eip' has been deprecated from provider version 1.215.0. Whether to bind EIP for an instance. Default: `false`.",
						},
						"enable": {
							Type:     schema.TypeBool,
							Optional: true,
						...
						"eip_internet_charge_type": {
							Type:         schema.TypeString,
							Optional:     true,
							Deprecated:   "Field 'eip_internet_charge_type' has been deprecated from provider version 1.215.0. The EIP billing type. Default value: 'PayByBandwidth '. Valid values:- `PayByBandwidth` : Billing based on fixed bandwidth.- `PayByTraffic` : Billing by usage flow.",
			...
			"security_group_id": {
				...
				Computed:   true,
				ForceNew:   true,
				Deprecated: "Field 'security_group_id' has been deprecated from provider version 1.215.0. The security group ID of the node pool. Select one of 'security_group_ids 'and 'security_group_ids'. Use 'security_group_ids 'recommend'.",
			},
			"security_group_ids": {
				Type:     schema.TypeList,
				Optional: true,
			...
			"name": {
				...
				Optional:   true,
				Computed:   true,
				Deprecated: "Field 'name' has been deprecated since provider version 1.215.0. New field 'node_pool_name' instead.",
			},
...
func resourceAliCloudAckNodepoolCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v := d.Get("kubelet_configuration"); !IsNil(v) {
		...
		if nodeNative108 != nil && nodeNative108 != "" {
			kubelet_configuration["kubeAPIBurst"] = nodeNative108
		}
...
func resourceAliCloudAckNodepoolRead(d *schema.ResourceData, meta interface{}) error {
	...
	if len(kubelet_configuration1Raw) > 0 {
		...
		kubeletConfigurationMap["event_burst"] = kubelet_configuration1Raw["eventBurst"]
		kubeletConfigurationMap["event_record_qps"] = kubelet_configuration1Raw["eventRecordQPS"]
		...
		kubeletConfigurationMap["kube_api_burst"] = kubelet_configuration1Raw["kubeAPIBurst"]
		kubeletConfigurationMap["kube_api_qps"] = kubelet_configuration1Raw["kubeAPIQPS"]
		...
		kubeletConfigurationMap["registry_burst"] = kubelet_configuration1Raw["registryBurst"]
		kubeletConfigurationMap["registry_pull_qps"] = kubelet_configuration1Raw["registryPullQPS"]
		kubeletConfigurationMap["serialize_image_pulls"] = kubelet_configuration1Raw["serializeImagePulls"]
