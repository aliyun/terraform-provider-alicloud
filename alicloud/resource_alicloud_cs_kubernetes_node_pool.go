	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"cis_enabled": {
				...
				Optional:   true,
				ForceNew:   true,
				Deprecated: "Field 'cis_enabled' has been deprecated from provider version 1.224.0. Whether enable worker node to support cis security reinforcement, its valid value `true` or `false`. Default to `false` and apply to AliyunLinux series. See [CIS Reinforcement](https://help.aliyun.com/document_detail/223744.html).",
			},
			"cluster_id": {
