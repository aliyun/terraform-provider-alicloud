			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"alicloud_nas_mount_target.foo", "access_group_name", "tf-testAccNasConfig"),
...
func TestAccAlicloudNas_MountTarget_Vpc_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccNasMountTargetVpcConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMountTargetExists("alicloud_nas_mount_target.foo", &mt),
					resource.TestCheckResourceAttr(
						"alicloud_nas_mount_target.foo", "access_group_name", "tf-testAccNasConfig"),
...
func TestAccAlicloudNas_MountTarget_update(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccNasMountTargetConfigUpdateAccessGroup,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMountTargetExists("alicloud_nas_mount_target.foo", &mt),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr("alicloud_nas_mount_target.foo", "vswitch_id", ""),
					resource.TestCheckResourceAttrSet("alicloud_nas_mount_target.foo", "file_system_id"),
					resource.TestCheckResourceAttr("alicloud_nas_mount_target.foo", "access_group_name", "tf-testAccNasConfig-2"),
				),
			},
			{
				Config: testAccNasMountTargetConfigUpdateStatus,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMountTargetExists("alicloud_nas_mount_target.foo", &mt),
					resource.TestCheckResourceAttr(
			...
			{
				Config: testAccNasMountTargetConfigUpdateAll,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMountTargetExists("alicloud_nas_mount_target.foo", &mt),
					resource.TestCheckResourceAttr(
						"alicloud_nas_mount_target.foo", "status", "Active"),
					resource.TestCheckResourceAttr("alicloud_nas_mount_target.foo", "vswitch_id", ""),
					resource.TestCheckResourceAttrSet("alicloud_nas_mount_target.foo", "file_system_id"),
					resource.TestCheckResourceAttr("alicloud_nas_mount_target.foo", "access_group_name", "tf-testAccNasConfig"),
				),
			},
		},
	})
...
resource "alicloud_nas_access_group" "foo" {
		name = "tf-testAccNasConfig"
		type = "Classic"
		description = "tf-testAccNasConfig"
}
resource "alicloud_nas_access_group" "bar" {
		name = "tf-testAccNasConfig-2"
		type = "Classic"
...
const testAccNasMountTargetVpcConfig = `
variable "name" {
...
`
const testAccNasMountTargetConfigUpdateAccessGroup = `
resource "alicloud_nas_file_system" "foo" {
		protocol_type = "NFS"
		storage_type = "Performance"
		description = "tf-testAccNasConfigFs"
...
const testAccNasMountTargetConfigUpdateStatus = `
resource "alicloud_nas_file_system" "foo" {
                protocol_type = "NFS"
                storage_type = "Performance"
		description = "tf-testAccNasConfigFs"
...
resource "alicloud_nas_access_group" "foo" {
                name = "tf-testAccNasConfigUpdate"
                type = "Classic"
                description = "tf-testAccNasConfig-1"
}
resource "alicloud_nas_access_group" "bar" {
                name = "tf-testAccNasConfig-2"
                type = "Classic"
...
const testAccNasMountTargetConfigUpdateAll = `
resource "alicloud_nas_file_system" "foo" {
                protocol_type = "NFS"
                storage_type = "Performance"
		description = "tf-testAccNasConfigFs"
