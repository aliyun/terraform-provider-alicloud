		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.ssl_vpn_client_cert_id"),
					resource.TestCheckResourceAttrSet("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.end_time"),
					resource.TestCheckResourceAttrSet("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.status"),
					resource.TestCheckResourceAttrSet("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.region_id"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.ssl_vpn_client_cert_id"),
					resource.TestCheckNoResourceAttr("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.region_id"),
					resource.TestCheckNoResourceAttr("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.end_time"),
					resource.TestCheckNoResourceAttr("data.alicloud_ssl_vpn_client_certs.foo", "ssl_vpn_client_certs.0.status"),
				),
			},
		},
	})
