...
func TestAccAlicloudCenTransitRouterRouteEntriesDataSource(t *testing.T) {
	...
	alicloudCenTransitRouterRouteEntriesCheckInfo.dataSourceTestCheck(t, rand, transitRouterRouteEntryIdsConf, transitRouterRouteEntryNamesConf, transitRouterRouteEntryStatusConf, allConf)
}
