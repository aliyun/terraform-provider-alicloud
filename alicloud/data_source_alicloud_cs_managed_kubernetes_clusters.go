	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"kube_config_file_prefix": {
				Type:     schema.TypeString,
				Optional: true,
				Deprecated: "Field 'kube_config_file_prefix' has been deprecated from provider version 1.225.0. Please use the attribute 'output_file' of new DataSource 'alicloud_cs_cluster_credential' to replace it.",
			},
			// Computed values
			"names": {
				Type:     schema.TypeList,
