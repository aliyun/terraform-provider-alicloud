...
func resourceAliCloudOssAccessPointCreate(d *schema.ResourceData, meta interface{}) error {
	...
	err = resource.Retry(d.Timeout(schema.TimeoutCreate), func() *resource.RetryError {
		response, err = client.RoaPutV2("Oss", "2019-05-17", "CreateAccessPoint", action, query, body, nil, hostMap, false)
		if err != nil {
			if NeedRetry(err) {
				wait()
...
func resourceAliCloudOssAccessPointUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if update {
		...
		err = resource.Retry(d.Timeout(schema.TimeoutUpdate), func() *resource.RetryError {
			response, err = client.RoaPutV2("Oss", "2019-05-17", "PutAccessPointPublicAccessBlock", action, query, body, nil, hostMap, false)
			if err != nil {
				if NeedRetry(err) {
					wait()
					return resource.RetryableError(err)
...
func resourceAliCloudOssAccessPointDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err = resource.Retry(d.Timeout(schema.TimeoutDelete), func() *resource.RetryError {
		response, err = client.RoaDeleteV2("Oss", "2019-05-17", "DeleteAccessPoint", action, query, nil, nil, hostMap, false)
		if err != nil {
