	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"group_name": {
				Type:     schema.TypeString,
				Optional: true,
				Removed:  "Field `group_name` has been removed from provider version 1.210.0.",
			},
			"instance_name": {
				Type:     schema.TypeString,
				Optional: true,
			...
			"phoenix_node_count": {
				Type:     schema.TypeInt,
				Optional: true,
				Removed:  "Field `phoenix_node_count` has been removed from provider version 1.210.0.",
			},
			"phoenix_node_specification": {
				Type:     schema.TypeString,
				Optional: true,
				Removed:  "Field `phoenix_node_specification` has been removed from provider version 1.210.0.",
			},
			"pricing_cycle": {
				Type:         schema.TypeString,
				Optional:     true,
