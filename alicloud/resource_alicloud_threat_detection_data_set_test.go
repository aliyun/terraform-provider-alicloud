		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"data_set_file_name":      "${data.alicloud_account.default.id}-example.csv",
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"data_set_field_key_name": "ip",
					"data_set_file_name":      "${data.alicloud_account.default.id}-test_file_u.csv",
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					"data_set_name":           "${var.name}",
					"data_set_field_key_name": "ip",
					"data_set_file_name":      "${data.alicloud_account.default.id}-test_file.csv",
					"data_set_description":    "description for test",
					"data_set_type":           "userDefined",
					"data_set_status":         1,
				}),
