...
func resourceAliyunApigatewayApiUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("service_type") || d.HasChange("http_service_config") || d.HasChange("http_vpc_service_config") || d.HasChange("mock_service_config") || d.HasChange("fc_service_config") {
		update = true
	}
