		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("alicloud_cs_application.basic", "services.0", "slave-java"),
					...
					resource.TestCheckResourceAttr("alicloud_cs_application.env", "services.1", "web"),
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckContainerApplicationExists("alicloud_cs_application.basic", &basic),
					resource.TestCheckResourceAttr("alicloud_cs_application.basic", "services.#", "1"),
					resource.TestCheckResourceAttr("alicloud_cs_application.basic", "services.0", "web"),
				),
			},
