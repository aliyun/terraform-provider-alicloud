...
func TestAccAliCloudRdsDBInstance_Mysql_8_0_cloud_ssd(t *testing.T) {
...
func TestAccAliCloudRdsDBInstance_Mysql_5_7_local_ssd(t *testing.T) {
	var instance map[string]interface{}
	resourceId := "alicloud_db_instance.default"
...
func TestAccAliCloudRdsDBInstance_SQLServer_2012_cloud_essd(t *testing.T) {
	var instance map[string]interface{}
	var ips []map[string]interface{}
...
func TestAccAliCloudRdsDBInstance_PostgreSQL_12_0_cloud_essd(t *testing.T) {
	var instance map[string]interface{}
	var ips []map[string]interface{}
...
func TestAccAliCloudRdsDBInstance_PostgreSQL_13_0_cloud_essd(t *testing.T) {
	var instance map[string]interface{}
	var ips []map[string]interface{}
...
func TestAccAliCloudRdsDBInstance_PostgreSQL_15_0_cloud_essd(t *testing.T) {
	var instance map[string]interface{}
	var ips []map[string]interface{}
	connectionStringPrefix := acctest.RandString(8) + "rm"
...
func TestAccAliCloudRdsDBInstance_MariaDB_10_3_cloud_essd(t *testing.T) {
	var instance map[string]interface{}
	var ips []map[string]interface{}
...
func TestAccAliCloudRdsDBInstance_Mysql_8_0_PrePaid_local_ssd(t *testing.T) {
	var instance map[string]interface{}
	var ips []map[string]interface{}
	resourceId := "alicloud_db_instance.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"force_restart", "period", "encryption_key", "db_is_ignore_case", "auto_renew_period", "direction", "auto_renew", "auto_renew_period"},
			},
		},
	})
}

func TestAccAliCloudRdsDBInstance_Mysql_8_0_cloud_essd(t *testing.T) {
	var instance map[string]interface{}
	resourceId := "alicloud_db_instance.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"force_restart", "period", "encryption_key", "direction", "auto_renew", "auto_renew_period", "optimized_writes"},
			},
		},
	})
}
