							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"ip_whitelist": {
										Type:       schema.TypeList,
										Optional:   true,
										Deprecated: "Field 'ip_whitelist' has been deprecated from provider version 1.243.0. New field 'ip_whitelists' instead.",
										Elem:       &schema.Schema{Type: schema.TypeString},
									},
									"flow_out_bandwidth": {
										Type:     schema.TypeInt,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"vswitch_id": {
										...
										Computed:   true,
										ForceNew:   true,
										Deprecated: "Field 'vswitch_id' has been deprecated from provider version 1.243.0. New field 'vswitches' instead.",
									},
									"vswitches": {
										Type:     schema.TypeList,
										Optional: true,
