...
func TestAccAlicloudLogResourceRecord_basic(t *testing.T) {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, resourceLogAlertResourceRecordDependence)
...
func resourceLogAlertResourceRecordDependence(name string) string {
	return ""
}
