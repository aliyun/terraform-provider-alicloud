		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"promotion_option_no":       os.Getenv("ALICLOUD_GA_PROMOTION_OPTION_NO"),
					"auto_pay":                  "true",
					"duration":                  "1",
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"auto_pay", "duration", "auto_use_coupon", "promotion_option_no", "pricing_cycle"},
			},
		},
	})
}
