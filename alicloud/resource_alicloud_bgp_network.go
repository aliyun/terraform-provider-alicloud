...
func resourceAliyunBgpNetworkCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err := bgpNetworkService.WaitForBgpNetwork(d.Id(), Active, DefaultLongTimeout); err != nil {
...
func resourceAliyunBgpNetworkDelete(d *schema.ResourceData, meta interface{}) error {
	...
	return WrapError(bgpNetworkService.WaitForBgpNetwork(d.Id(), Deleted, DefaultLongTimeout))
}
