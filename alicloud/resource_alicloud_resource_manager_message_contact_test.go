...
// Case MessageContact-资源用例 11255
func TestAccAliCloudResourceManagerMessageContact_basic11255(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_resource_manager_message_contact.default"
	ra := resourceAttrInit(resourceId, AlicloudResourceManagerMessageContactMap11255)
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudResourceManagerMessageContactBasicDependence11255)
...
var AlicloudResourceManagerMessageContactMap11255 = map[string]string{
	"status":      CHECKSET,
	"create_time": CHECKSET,
}

func AlicloudResourceManagerMessageContactBasicDependence11255(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
