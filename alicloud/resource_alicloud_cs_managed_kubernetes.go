	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"client_cert": {
				Type:     schema.TypeString,
				Optional: true,
				Deprecated: "Field 'client_cert' has been deprecated from provider version 1.245.0. From version 1.245.0, new DataSource 'alicloud_cs_cluster_credential' is recommended to manage cluster's kubeconfig, you can also save the 'certificate_authority.client_cert' attribute content of new DataSource 'alicloud_cs_cluster_credential' to an appropriate path(like ~/.kube/client-cert.pem) for replace it.",
			},
			"client_key": {
				Type:     schema.TypeString,
				Optional: true,
				Deprecated: "Field 'client_key' has been deprecated from provider version 1.245.0. From version 1.245.0, new DataSource 'alicloud_cs_cluster_credential' is recommended to manage cluster's kubeconfig, you can also save the 'certificate_authority.client_key' attribute content of new DataSource 'alicloud_cs_cluster_credential' to an appropriate path(like ~/.kube/client-key.pem) for replace it.",
			},
			"cluster_ca_cert": {
				Type:     schema.TypeString,
				Optional: true,
				Deprecated: "Field 'cluster_ca_cert' has been deprecated from provider version 1.245.0. From version 1.245.0, new DataSource 'alicloud_cs_cluster_credential' is recommended to manage cluster's kubeconfig, you can also save the 'certificate_authority.cluster_cert' attribute content of new DataSource 'alicloud_cs_cluster_credential' to an appropriate path(like ~/.kube/cluster-ca-cert.pem) for replace it.",
			},
			"certificate_authority": {
				...
				Deprecated: "Field 'certificate_authority' has been deprecated from provider version 1.245.0. Please use the attribute 'certificate_authority' of new DataSource 'alicloud_cs_cluster_credential' to replace it.",
			},
...
func resourceAlicloudCSManagedKubernetesRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err = setCerts(d, meta, d.Get("set_certificate_authority").(bool)); err != nil {
		return WrapError(err)
	}
