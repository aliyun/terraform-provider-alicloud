...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cms_notify_strategies":                          dataSourceAliCloudCmsNotifyStrategies(),
			"alicloud_cms_subscriptions":                              dataSourceAliCloudCmsSubscriptions(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cms_notify_strategy":                                  resourceAliCloudCmsNotifyStrategy(),
			"alicloud_cms_subscription":                                     resourceAliCloudCmsSubscription(),
