...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_data_set":                        dataSourceAlicloudThreatDetectionDataSet(),
			"alicloud_threat_detection_data_sets":                       dataSourceAlicloudThreatDetectionDataSets(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_data_set":                             resourceAliCloudThreatDetectionDataSet(),
