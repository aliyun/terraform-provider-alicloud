...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cms_alert_notify_templates":                     dataSourceAliCloudCmsAlertNotifyTemplates(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cms_alert_notify_template":                            resourceAliCloudCmsAlertNotifyTemplate(),
