...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_ens_network_peer_connections":                     dataSourceAlicloudEnsNetworkPeerConnections(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_ens_network_peer_connection":                          resourceAliCloudEnsNetworkPeerConnection(),
