...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cs_serveless_kubernetes_clusters": dataSourceAlicloudCSServelessKubernetesClusters(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cs_serveless_kubernetes":             resourceAlicloudCSServelessKubernetes(),
