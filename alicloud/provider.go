...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_ens_load_balancer_tcp_listener":                   dataSourceAlicloudEnsLoadBalancerTcpListener(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_ens_load_balancer_tcp_listener":                       resourceAliCloudEnsLoadBalancerTcpListener(),
