...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_rocketmq_disaster_recovery_plans":                 dataSourceAlicloudRocketmqDisasterRecoveryPlans(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_rocketmq_disaster_recovery_plan":                      resourceAliCloudRocketmqDisasterRecoveryPlan(),
