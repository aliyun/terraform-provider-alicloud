...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_apig_consumer":                                        resourceAliCloudApigConsumer(),
			"alicloud_apig_consumer_authorization_rules":                    resourceAliCloudApigConsumerAuthorizationRules(),
			...
			"alicloud_apig_http_api_deployment":                             resourceAliCloudApigHttpApiDeployment(),
