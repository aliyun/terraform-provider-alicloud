...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_data_connectors":                 dataSourceAlicloudThreatDetectionDataConnectors(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_data_connector":                       resourceAlicloudThreatDetectionDataConnector(),
