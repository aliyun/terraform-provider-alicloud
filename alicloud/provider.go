...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cloud_firewall_vpc_cen_tr_firewall_policies":    dataSourceAliCloudCloudFirewallVpcCenTrFirewallPolicies(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cloud_firewall_vpc_cen_tr_firewall_policy":            resourceAliCloudCloudFirewallVpcCenTrFirewallPolicy(),
