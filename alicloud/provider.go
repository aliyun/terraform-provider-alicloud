...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cms_alert_event_integration_policies":           dataSourceAlicloudCmsAlertEventIntegrationPolicies(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cms_alert_event_integration_policy":                   resourceAliCloudCmsAlertEventIntegrationPolicy(),
