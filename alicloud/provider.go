...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_sas_private_link_endpoints":      dataSourceAlicloudThreatDetectionSasPrivateLinkEndpoints(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_sas_private_link_endpoint":            resourceAlicloudThreatDetectionSasPrivateLinkEndpoint(),
