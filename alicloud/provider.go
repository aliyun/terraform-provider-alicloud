...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_custom_check_standard_policies":  dataSourceAlicloudThreatDetectionCustomCheckStandardPolicies(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_threat_detection_custom_check_standard_policy":         resourceAliCloudThreatDetectionCustomCheckStandardPolicy(),
