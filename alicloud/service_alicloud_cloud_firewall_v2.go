...
func (s *CloudFirewallServiceV2) CloudFirewallVpcCenTrFirewallPolicyStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.CloudFirewallVpcCenTrFirewallPolicyStateRefreshFuncWithApi(id, field, failStates, s.DescribeCloudFirewallVpcCenTrFirewallPolicy)
}

func (s *CloudFirewallServiceV2) CloudFirewallVpcCenTrFirewallPolicyStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
