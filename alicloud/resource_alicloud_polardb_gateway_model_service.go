...
func resourceAlicloudPolarDBGatewayModelServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	for field, responseKey := range map[string]string{
		"input_cost_points_per_million":  "InputCostPointsPerMillion",
		"output_cost_points_per_million": "OutputCostPointsPerMillion",
		"request_cost_points":            "RequestCostPoints",
	} {
		if value, ok := object[responseKey]; ok {
