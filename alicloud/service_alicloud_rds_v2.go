...
// DescribeRdsParameterGroup <<< Encapsulated get interface for Rds ParameterGroup.

func (s *RdsServiceV2) DescribeRdsParameterGroup(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *RdsServiceV2) RdsParameterGroupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.RdsParameterGroupStateRefreshFuncWithApi(id, field, failStates, s.DescribeRdsParameterGroup)
}

func (s *RdsServiceV2) RdsParameterGroupStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeRdsParameterGroup >>> Encapsulated.
