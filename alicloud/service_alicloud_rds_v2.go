...
// DescribeRdsBackupPolicy <<< Encapsulated get interface for Rds BackupPolicy.

func (s *RdsServiceV2) DescribeRdsBackupPolicy(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *RdsServiceV2) RdsBackupPolicyStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.RdsBackupPolicyStateRefreshFuncWithApi(id, field, failStates, s.DescribeRdsBackupPolicy)
}

func (s *RdsServiceV2) RdsBackupPolicyStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeRdsBackupPolicy >>> Encapsulated.
