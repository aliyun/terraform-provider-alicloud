		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAlicloudApigatewayGroupExists("alicloud_apigateway_api_group.apiGroup1", &group),
					resource.TestCheckResourceAttr("alicloud_apigateway_api_group.apiGroup1", "name", "apigateway—testgroup"),
				),
			},
		},
	})
