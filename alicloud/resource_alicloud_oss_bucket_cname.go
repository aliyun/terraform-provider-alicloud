...
func resourceAliCloudOssBucketCnameCreate(d *schema.ResourceData, meta interface{}) error {
	...
	err = resource.Retry(d.Timeout(schema.TimeoutCreate), func() *resource.RetryError {
		response, err = client.RoaPostV2("Oss", "2019-05-17", "PutCname", action, query, body, nil, hostMap, false)
		if err != nil {
...
func resourceAliCloudOssBucketCnameDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err = resource.Retry(d.Timeout(schema.TimeoutDelete), func() *resource.RetryError {
		response, err = client.RoaPostV2("Oss", "2019-05-17", "DeleteCname", action, query, body, nil, hostMap, false)
		if err != nil {
			if NeedRetry(err) {
				wait()
				return resource.RetryableError(err)
