					...
					"routes": []map[string]interface{}{
						{
							"channels": []map[string]interface{}{
								{
									"channel_type":         "GROUP",
									"receivers":            []string{"${alicloud_cms_alarm_contact_group.default.id}"},
...
resource "alicloud_cms_alarm_contact" "default" {
  ...
  describe           = "tf-acc cms notify strategy contact"
...
resource "alicloud_cms_alarm_contact_group" "default" {
  alarm_contact_group_name = "${var.name}-group"
  contacts                 = [alicloud_cms_alarm_contact.default.id]
  describe                 = "tf-acc cms notify strategy group"
}
