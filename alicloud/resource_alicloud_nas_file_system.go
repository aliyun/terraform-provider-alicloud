...
func resourceAliCloudNasFileSystemRead(d *schema.ResourceData, meta interface{}) error {
	...
	if (checkValue00 == "standard") && (checkValue00 == "standard" && checkValue01 == "SMB") {
	...
	checkValue01 = d.Get("protocol_type")
	if (checkValue00 == "standard") && (checkValue00 == "standard" && checkValue01 == "NFS") {
...
func resourceAliCloudNasFileSystemUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("recycle_bin") {
		update = true
	}
	if v, ok := d.GetOk("recycle_bin"); ok {
		query["ReservedDays"] = StringPointer(v.(string))
	}
