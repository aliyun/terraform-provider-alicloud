		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					/**
					resource.TestCheckResourceAttrSet("alicloud_slb_server_certificate.foo",
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSlbServerCertificateExists("alicloud_slb_server_certificate.foo", &sc),
					resource.TestCheckResourceAttr(
						"alicloud_slb_server_certificate.foo", "name", "tf-testAccSlbServerCertificateUpdate"),
					resource.TestCheckResourceAttr(
						"alicloud_slb_server_certificate.foo", "server_certificate", "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"),
					resource.TestCheckResourceAttr(
						"alicloud_slb_server_certificate.foo", "private_key", "-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----"),
