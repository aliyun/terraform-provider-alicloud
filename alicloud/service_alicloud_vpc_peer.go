...
func (s *VpcPeerService) DescribeVpcPeering(id string) (object map[string]interface{}, err error) {
...
func (s *VpcPeerService) VpcPeeringStateRefreshFunc(id string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeVpcPeering(id)
		if err != nil {
