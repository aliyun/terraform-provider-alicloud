		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.alicloud_rds_instances.rds", "instances.0.instance_class", "rds.mysql.t1.small"),
					...
					resource.TestCheckResourceAttr("data.alicloud_rds_instances.rds", "instances.0.charge_type", Postpaid),
				),
			},
		},
	})
