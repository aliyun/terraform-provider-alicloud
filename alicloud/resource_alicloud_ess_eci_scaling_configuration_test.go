		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"security_group_id":          "sg-bp1hi5tpb5c3e51a15",
					...
					"containers": []map[string]interface{}{
						{
							...
							"liveness_probe_exec_commands":          []string{"echo"},
							...
							"readiness_probe_exec_commands":         []string{"echo"},
...
func TestAccAliCloudEssEciScalingConfigurationUpdate(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_ess_eci_scaling_configuration.default"
	ra := resourceAttrInit(resourceId, AlicloudEssEciScalingConfigurationMap)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
