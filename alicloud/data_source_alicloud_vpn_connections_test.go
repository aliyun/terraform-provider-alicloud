...
func TestAccAlicloudVPNConnectionsDataSourceBasic(t *testing.T) {
	...
	var existVpnConnectionsMapFunc = func(rand int) map[string]string {
		return map[string]string{
			...
			"connections.0.health_check_config.0.dip":      "192.168.10.1",
			"connections.0.health_check_config.0.sip":      "10.10.1.1",
			"connections.0.health_check_config.0.retry":    "3",
			"connections.0.health_check_config.0.interval": "3",
			"connections.0.vpn_bgp_config.0.local_asn":     "45104",
			"connections.0.vpn_bgp_config.0.tunnel_cidr":   "169.254.11.0/30",
			"connections.0.vpn_bgp_config.0.local_bgp_ip":  "169.254.11.1",
		}
	}
