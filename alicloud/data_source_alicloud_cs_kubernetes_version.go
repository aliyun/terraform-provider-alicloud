...
const datasourceCsKubernetesVersion = "alicloud_cs_kubernetes_version"
...
func dataSourceAlicloudCSKubernetesVersionRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, datasourceCsKubernetesVersion, "DescribeKubernetesVersionMetadata", AlibabaCloudSdkGoERROR)
	}
...
func describeKubernetesVersionMetadata(d *schema.ResourceData, client *connectivity.AliyunClient) ([]*cs.DescribeKubernetesVersionMetadataResponseBody, error) {
	...
	if err != nil {
		return nil, WrapErrorf(err, DataDefaultErrorMsg, datasourceCsKubernetesVersion, "InitClient", ProviderERROR)
	}
