		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("alicloud_elasticsearch_instance.foo", "kiabana_domain"),
					resource.TestCheckResourceAttrSet("alicloud_elasticsearch_instance.foo", "kiabana_port"),
