	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"force", "order_action_type", "password", "pvl_id", "update_strategy"},
			},
		},
	})
}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"force", "order_action_type", "password", "pvl_id", "update_strategy", "period", "renew_status", "auto_renew_duration", "renewal_duration_unit"},
			},
		},
	})
}
