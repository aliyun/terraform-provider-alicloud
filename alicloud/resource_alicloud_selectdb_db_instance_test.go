...
func TestAccAliCloudSelectDBDbInstance_basic_info(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"maintain_start_time": "1970-01-01T02:00Z",
					"maintain_end_time":   "1970-01-01T03:00Z",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"maintain_start_time": "1970-01-01T02:00Z",
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"maintain_start_time":     "1970-01-01T01:00Z",
					"maintain_end_time":       "1970-01-01T02:00Z",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						"db_instance_description": name + "_updateAll",
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"gmt_modified", "desired_cache_size", "db_instance_class", "enable_public_network", "desired_engine_version"},
			},
		},
	})
}

func TestAccAliCloudSelectDBDbInstance_basic_payment_modify(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_selectdb_db_instance.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:       true,
				ImportStateVerify: true,
				ImportStateVerifyIgnore: []string{"gmt_modified", "desired_cache_size", "db_instance_class",
					"enable_public_network", "period", "period_time", "desired_engine_version"},
			},
		},
	})
}
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"security_ip_lists", "gmt_modified",
					"desired_security_ip_lists", "desired_cache_size", "db_instance_class",
					"enable_public_network", "desired_engine_version"},
			},
		},
	})
}
...
func TestAccAliCloudSelectDBDbInstance_upgrade(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"upgraded_engine_minor_version": "4.0.1",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
			...
			},
			{
				...
				ImportState:       true,
				ImportStateVerify: true,
				ImportStateVerifyIgnore: []string{"upgraded_engine_minor_version", "gmt_modified",
					"engine_minor_version", "desired_cache_size", "db_instance_class", "desired_engine_version",
...
func TestAccAliCloudSelectDBDbInstance_default_cluster(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_selectdb_db_instance.default"
	ra := resourceAttrInit(resourceId, AliCloudSelectDBDbInstanceMap0)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"gmt_modified", "desired_cache_size", "desired_engine_version", "db_instance_class", "enable_public_network", "desired_engine_version"},
			},
		},
	})
}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"instance_net_infos", "gmt_modified", "desired_cache_size", "desired_engine_version", "db_instance_class", "enable_public_network"},
			},
		},
	})
}
