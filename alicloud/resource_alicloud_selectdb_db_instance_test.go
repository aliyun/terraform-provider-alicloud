		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"security_ip_lists", "gmt_modified",
					"instance_net_infos", "desired_security_ip_lists", "desired_cache_size", "db_instance_class",
...
func TestAccAliCloudSelectDBDbInstance_basic_payment_modify_ungrade(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_selectdb_db_instance.default"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:       true,
				ImportStateVerify: true,
				ImportStateVerifyIgnore: []string{"gmt_modified", "desired_cache_size", "db_instance_class", "upgraded_engine_minor_version",
					"enable_public_network", "period", "period_time", "desired_engine_version", "instance_net_infos", "engine_minor_version"},
			},
		},
	})
}
