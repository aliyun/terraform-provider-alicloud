...
var ECDSupportRegions = []Region{EUWest1, MEEast1, GuangZhou, APSouthEast5, Hongkong, EUCentral1, Shenzhen, USEast1, Hangzhou, Qingdao, USWest1, APSouthEast1, APSouthEast6, APNorthEast1, ChengDu, APSouthEast2, APSouthEast3, Beijing, Shanghai, HeYuan, Zhangjiakou, Huhehaote, WuLanChaBu, APSouth1, CnNorth2Gov1}