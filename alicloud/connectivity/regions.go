...
var GPDBServerlessSupportRegions = []Region{Beijing, APSouth1, ChengDu, Shanghai, APSouthEast3, Huhehaote, USWest1, ShanghaiFinance, Hongkong, APSouthEast2, USEast1, Zhangjiakou, Hangzhou, Shenzhen, EUWest1, APNorthEast1, APSouthEast5}
