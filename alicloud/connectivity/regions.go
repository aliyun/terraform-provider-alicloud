...
var VpnGatewayVpnAttachmentSupportRegions = []Region{EUCentral1}
...
var VpcVSwitchCidrReservationSupportRegions = []Region{APSouthEast2, Hangzhou}
var VpcIpv6EgressRuleSupportRegions = []Region{Hangzhou}
var VpcIpv6InternetBandwidthSupportRegions = []Region{Hangzhou}
