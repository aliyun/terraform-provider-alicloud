...
// RoaPostV2 invoking OSS API request with POST method
// parameters:
//
//	apiProductCode: API Product code, its value equals to the gateway code of the API
//	apiVersion - API version
...
//	body - API parameters in body
//	autoRetry - whether to auto retry while the runtime has a 5xx error
func (client *AliyunClient) RoaPostV2(apiProductCode string, apiVersion string, apiName string, pathName string, query map[string]*string, body interface{}, headers map[string]*string, hostMap map[string]*string, autoRetry bool) (map[string]interface{}, error) {
	return client.roaRequestV2("POST", apiProductCode, apiVersion, apiName, pathName, query, body, headers, hostMap, autoRetry)
}

// RoaPutV2 invoking OSS API request with POST method
// parameters:
//
//	apiProductCode: API Product code, its value equals to the gateway code of the API
//	apiVersion - API version
...
//	body - API parameters in body
//	autoRetry - whether to auto retry while the runtime has a 5xx error
func (client *AliyunClient) RoaPutV2(apiProductCode string, apiVersion string, apiName string, pathName string, query map[string]*string, body interface{}, headers map[string]*string, hostMap map[string]*string, autoRetry bool) (map[string]interface{}, error) {
	return client.roaRequestV2("PUT", apiProductCode, apiVersion, apiName, pathName, query, body, headers, hostMap, autoRetry)
}

// RoaGetV2 invoking OSS API request with POST method
// parameters:
//
//	apiProductCode: API Product code, its value equals to the gateway code of the API
//	apiVersion - API version
...
//	hostMap - API parameters in HostMap
//	body - API parameters in body
func (client *AliyunClient) RoaGetV2(apiProductCode string, apiVersion string, apiName string, pathName string, query map[string]*string, body interface{}, headers map[string]*string, hostMap map[string]*string) (map[string]interface{}, error) {
	return client.roaRequestV2("GET", apiProductCode, apiVersion, apiName, pathName, query, body, headers, hostMap, false)
}

// RoaDeleteV2 invoking OSS API request with POST method
// parameters:
//
//	apiProductCode: API Product code, its value equals to the gateway code of the API
//	apiVersion - API version
...
//	body - API parameters in body
//	autoRetry - whether to auto retry while the runtime has a 5xx error
func (client *AliyunClient) RoaDeleteV2(apiProductCode string, apiVersion string, apiName string, pathName string, query map[string]*string, body interface{}, headers map[string]*string, hostMap map[string]*string, autoRetry bool) (map[string]interface{}, error) {
	return client.roaRequestV2("DELETE", apiProductCode, apiVersion, apiName, pathName, query, body, headers, hostMap, autoRetry)
}

func (client *AliyunClient) roaRequestV2(method string, apiProductCode string, apiVersion string, apiName string, pathName string, query map[string]*string, body interface{}, headers map[string]*string, hostMap map[string]*string, autoRetry bool) (map[string]interface{}, error) {
	apiProductCode = strings.ToLower(ConvertKebabToSnake(apiProductCode))
	endpoint, err := client.loadApiEndpoint(apiProductCode)
	if err != nil {
		return nil, err
	...
	runtime.SetAutoretry(autoRetry)
	response, err = openapiClient.Execute(client.genXmlParam(apiName, method, apiVersion, pathName), &openapi.OpenApiRequest{Query: query, Body: body, Headers: headers, HostMap: hostMap}, runtime)
	if respBody, isExist := response["body"]; isExist && respBody != nil {
...
func (client *AliyunClient) genXmlParam(action, method, version, path string) *openapi.Params {
	return &openapi.Params{
		Action:      tea.String(action),
		Version:     tea.String(version),
		Protocol:    tea.String(client.config.Protocol),
