...
resource "alicloud_cloud_firewall_vpc_cen_tr_firewall" "default" {
  ...
  tr_attachment_master_zone = data.alicloud_cen_transit_router_available_resources.default.resources[0].master_zones[0]
  transit_router_id = alicloud_cen_transit_router.tr.transit_router_id
  tr_attachment_slave_cidr = "192.168.3.128/26"
  region_no = var.region
  route_mode = "managed"
  tr_attachment_slave_zone = data.alicloud_cen_transit_router_available_resources.default.resources[0].master_zones[1]
