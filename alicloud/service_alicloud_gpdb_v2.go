...
// DescribeGpdbDBInstance <<< Encapsulated get interface for Gpdb DBInstance.

func (s *GpdbServiceV2) DescribeGpdbDBInstance(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"InvalidDBInstanceId.NotFound"}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("DBInstance", id)), NotFoundMsg, response)
		}
		addDebug(action, response, request)
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
	...
	for _, v := range result {
		item := v.(map[string]interface{})
		if fmt.Sprint(item["DBInstanceId"]) != id {
			continue
		}
		if fmt.Sprint(item["Engine"]) != "gpdb" {
			continue
		}
		if fmt.Sprint(item["MasterNodeNum"]) != "1" {
			continue
		}
		return item, nil
	}
...
func (s *GpdbServiceV2) DescribeDescribeDataReDistributeInfo(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeDBInstanceSupportMaxPerformance(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeDBInstanceIPArrayList(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeDBInstanceSSL(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeDBClusterNode(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeSampleData(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeDataShareInstances(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) DescribeDescribeDBResourceManagementMode(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *GpdbServiceV2) GpdbDBInstanceStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
...
// DescribeGpdbDBInstance >>> Encapsulated.

// SetResourceTags <<< Encapsulated tag function for Gpdb.
func (s *GpdbServiceV2) SetResourceTags(d *schema.ResourceData, resourceType string) error {
	if d.HasChange("tags") {
		var err error
		var action string
		var conn *rpc.Client
