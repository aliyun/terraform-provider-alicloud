	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"db_cluster_description", "cache_size", "desired_cache_size"},
			},
		},
	})
}

func TestAccAliCloudSelectDBDbCluster_config_list(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_selectdb_db_cluster.default"
	ra := resourceAttrInit(resourceId, AliCloudSelectDBDbClusterMap0)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"db_cluster_class", "desired_params", "desired_cache_size"},
			},
		},
	})
}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				ResourceName:      resourceId,
				ImportState:       true,
				ImportStateVerify: true, ImportStateVerifyIgnore: []string{"status", "desired_cache_size", "desired_status"},
			},
		},
	})
}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				ResourceName:      resourceId,
				ImportState:       true,
				ImportStateVerify: true, ImportStateVerifyIgnore: []string{"db_cluster_class", "desired_cache_size"},
			},
		},
	})
}
