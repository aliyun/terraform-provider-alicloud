...
func TestAccAliCloudCmsEntityGroup_tagsOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"entity_rules": []map[string]interface{}{
						{
							"tags": []map[string]interface{}{
								{"op": "add", "tag_key": "Env", "tag_values": []string{"test"}},
								{"op": "remove", "tag_key": "Team", "tag_values": []string{"tf"}},
							},
						},
					},
				}),
...
func TestAccAliCloudCmsEntityGroup_tagsTagValuesOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"entity_rules": []map[string]interface{}{
						{
							"tags": []map[string]interface{}{
								{"op": "add", "tag_key": "Env", "tag_values": []string{"v1", "v2"}},
							},
						},
					},
				}),
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"entity_rules": []map[string]interface{}{
						{
							"tags": []map[string]interface{}{
								{"op": "add", "tag_key": "Env", "tag_values": []string{"v2", "v1"}},
							},
						},
					},
				}),
...
func TestAccAliCloudCmsEntityGroup_labelsOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
...
func TestAccAliCloudCmsEntityGroup_labelsTagValuesOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
...
func TestAccAliCloudCmsEntityGroup_annotationsOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
...
func TestAccAliCloudCmsEntityGroup_annotationsTagValuesOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
...
func TestAccAliCloudCmsEntityGroup_fieldRulesOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"entity_rules": []map[string]interface{}{
						{
							"field_rules": []map[string]interface{}{
								{"field_key": "region", "op": "eq", "field_values": []string{"cn-hangzhou"}},
								{"field_key": "zone", "op": "ne", "field_values": []string{"cn-beijing"}},
							},
						},
					},
				}),
...
func TestAccAliCloudCmsEntityGroup_fieldRulesFieldValuesOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"entity_rules": []map[string]interface{}{
						{
							"field_rules": []map[string]interface{}{
								{"field_key": "region", "op": "in", "field_values": []string{"v1", "v2"}},
							},
						},
					},
				}),
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"entity_rules": []map[string]interface{}{
						{
							"field_rules": []map[string]interface{}{
								{"field_key": "region", "op": "in", "field_values": []string{"v2", "v1"}},
							},
						},
					},
				}),
...
func TestAccAliCloudCmsEntityGroup_entityTypesOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
...
func TestAccAliCloudCmsEntityGroup_instanceIdsOrder(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_cms_entity_group.default"
	rand := acctest.RandIntRange(10000, 99999)
	name := fmt.Sprintf("tf-testacc%d", rand)
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"workspace":         "${alicloud_cms_workspace.default.id}",
					"entity_rules": []map[string]interface{}{
						{"instance_ids": []string{"i-bp1test0001", "i-bp1test0002"}},
					},
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAlicloudCmsEntityGroupExists(resourceId, v),
			...
			},
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"workspace":         "${alicloud_cms_workspace.default.id}",
					"entity_rules": []map[string]interface{}{
						{"instance_ids": []string{"i-bp1test0002", "i-bp1test0001"}},
					},
				}),
				PlanOnly:           true,
				ExpectNonEmptyPlan: true,
