...
// DescribeEnsNetworkInterface <<< Encapsulated get interface for Ens NetworkInterface.

func (s *EnsServiceV2) DescribeEnsNetworkInterface(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *EnsServiceV2) EnsNetworkInterfaceStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.EnsNetworkInterfaceStateRefreshFuncWithApi(id, field, failStates, s.DescribeEnsNetworkInterface)
}

func (s *EnsServiceV2) EnsNetworkInterfaceStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeEnsNetworkInterface >>> Encapsulated.
