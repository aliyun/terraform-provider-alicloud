...
func resourceAlicloudPolarDBGatewayBudgetPolicyRead(d *schema.ResourceData, meta interface{}) error {
	...
	values := map[string]interface{}{
		...
		"budget_dimension_ref_id": object["BudgetDimensionRefId"], "budget_dimension_type": object["BudgetDimensionType"],
		"reset_day_of_month": polarDBGatewayAIInt(object["ResetDayOfMonth"]), "budget_points": object["BudgetPoints"],
