...
func dataSourceAlicloudDBInstanceClassesInfo() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAlicloudDBInstanceClassesInfoRead,
...
func dataSourceAlicloudDBInstanceClassesInfoRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DataDefaultErrorMsg, "alicloud_db_instance_classes_infos", action, AlibabaCloudSdkGoERROR)
	}
	...
	if err := d.Set("instance_classes_infos", result); err != nil {
		return WrapError(err)
	}
