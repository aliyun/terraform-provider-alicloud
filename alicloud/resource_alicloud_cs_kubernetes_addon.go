...
const resourceCsKubernetesAddon = "alicloud_cs_kubernetes_addon"
...
func resourceAlicloudCSKubernetesAddonRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, resourceCsKubernetesAddon, "InitClient", ProviderERROR)
	}
...
func resourceAlicloudCSKubernetesAddonCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if changed {
		if _, err := stateConf.WaitForState(); err != nil {
			return WrapErrorf(err, DefaultErrorMsg, resourceCsKubernetesAddon, "WaitForSuccessAfterCreate", d.Id())
		}
	}
...
func resourceAlicloudCSKubernetesAddonUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("version") {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, resourceCsKubernetesAddon, "UpgradeAddonConfig", AlibabaCloudSdkGoERROR)
		}
	}
	...
	if _, err := stateConf.WaitForState(); err != nil {
		return WrapErrorf(err, DefaultErrorMsg, resourceCsKubernetesAddon, "WaitForSuccessAfterUpdate", d.Id())
	}
...
func resourceAlicloudCSKubernetesAddonDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, resourceCsKubernetesAddon, "UninstallAddon", AlibabaCloudSdkGoERROR)
	}
	...
	if _, err := stateConf.WaitForState(); err != nil {
		return WrapErrorf(err, DefaultErrorMsg, resourceCsKubernetesAddon, "WaitForSuccessAfterDelete", d.Id())
	}
