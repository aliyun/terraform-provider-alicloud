...
func (c *CrService) CreateCrEENamespace(instanceId string, namespaceName string, autoCreate bool, visibility string) (*cr_ee.CreateNamespaceResponse, error) {
...
func (c *CrService) UpdateCrEENamespace(instanceId string, namespaceName string, autoCreate bool, visibility string) (*cr_ee.UpdateNamespaceResponse, error) {
...
func (c *CrService) CreateCrEERepo(instanceId, namespaceName, repoName, repoType, summary, detail string) (*cr_ee.CreateRepositoryResponse, error) {
	response := &cr_ee.CreateRepositoryResponse{}
	request := cr_ee.CreateCreateRepositoryRequest()
	request.RegionId = c.client.RegionId
	request.InstanceId = instanceId
	request.RepoNamespaceName = namespaceName
	request.RepoName = repoName
	request.RepoType = repoType
	request.Summary = summary
	request.Detail = detail
	resource := c.GenResourceId(instanceId, namespaceName, repoName)
	action := request.GetActionName()
...
func (c *CrService) UpdateCrEERepo(instanceId, namespace, repo, repoId, repoType, summary, detail string) (*cr_ee.UpdateRepositoryResponse, error) {
...
func (c *CrService) GenResourceId(args ...string) string {
	return strings.Join(args, SLASH_SEPARATED)
}

func (c *CrService) ParseResourceId(id string) []string {
	return strings.Split(id, SLASH_SEPARATED)
}
