		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "name", "tf-testAccSlbServerGroupVpc"),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "servers.#", "2"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSlbServerGroupExists("alicloud_slb_server_group.group", &group),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "name", "tf-testAccSlbServerGroupVpcUpdate"),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "servers.#", "2"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSlbServerGroupExists("alicloud_slb_server_group.group", &group),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "name", "tf-testAccSlbServerGroupVpcUpdate"),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "servers.#", "1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSlbServerGroupExists("alicloud_slb_server_group.group", &group),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "name", "tf-testAccSlbServerGroupEmpty"),
					resource.TestCheckResourceAttr("alicloud_slb_server_group.group", "servers.#", "0"),
				),
			},
		},
	})
