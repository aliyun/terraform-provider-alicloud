...
// Case 4256
func TestAccAliCloudMessageServiceQueue_basic4256(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_message_service_queue.default"
	ra := resourceAttrInit(resourceId, AlicloudMessageServiceQueueMap4256)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudMessageServiceQueueBasicDependence4256)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudMessageServiceQueueMap4256 = map[string]string{
	"polling_wait_seconds":     "0",
...
func AlicloudMessageServiceQueueBasicDependence4256(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
// Case 4256  twin
func TestAccAliCloudMessageServiceQueue_basic4256_twin(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_message_service_queue.default"
	ra := resourceAttrInit(resourceId, AlicloudMessageServiceQueueMap4256)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
