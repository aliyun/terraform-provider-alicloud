...
func TestAccAlicloudAlidnsDomainsDataSource(t *testing.T) {
	...
	aliDomainConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ali_domain":        "false",
			"domain_name_regex": "${alicloud_alidns_domain.default.domain_name}",
		}),
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alicloud_alidns_domain.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"ids": []string{"${alicloud_alidns_domain.default.id}-fake"},
		}),
	}
