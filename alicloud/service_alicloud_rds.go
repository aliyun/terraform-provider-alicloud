...
func (s *RdsService) RdsInstanceStateRefreshFunc(id string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		...
		for _, failState := range failStates {
			if strings.EqualFold(object.DBInstanceStatus, failState) {
