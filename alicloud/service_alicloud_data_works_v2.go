...
// DescribeDataWorksDataServiceGroup <<< Encapsulated get interface for DataWorks DataServiceGroup.

func (s *DataWorksServiceV2) DescribeDataWorksDataServiceGroup(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
func (s *DataWorksServiceV2) DataWorksDataServiceGroupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return s.DataWorksDataServiceGroupStateRefreshFuncWithApi(id, field, failStates, s.DescribeDataWorksDataServiceGroup)
}

func (s *DataWorksServiceV2) DataWorksDataServiceGroupStateRefreshFuncWithApi(id string, field string, failStates []string, call func(id string) (map[string]interface{}, error)) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := call(id)
		if err != nil {
			if NotFoundError(err) {
...
// DescribeDataWorksDataServiceGroup >>> Encapsulated.
