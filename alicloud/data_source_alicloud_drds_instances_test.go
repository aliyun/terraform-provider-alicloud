		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("data.alicloud_db_instances.dbs", "instances.0.type"),
					resource.TestCheckNoResourceAttr("data.alicloud_db_instances.dbs", "instances.0.zone_id"),
					resource.TestCheckNoResourceAttr("data.alicloud_db_instances.dbs", "instances.0.version"),
					resource.TestCheckNoResourceAttr("data.alicloud_db_instances.dbs", "instances.0.id"),
					resource.TestCheckNoResourceAttr("data.alicloud_db_instances.dbs", "instances.0.network_type"),
					resource.TestCheckNoResourceAttr("data.alicloud_db_instances.dbs", "instances.0.create_time"),
				),
			},
		},
	})
