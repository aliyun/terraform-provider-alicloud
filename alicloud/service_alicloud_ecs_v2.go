...
// DescribeEcsSavingPlan <<< Encapsulated get interface for Ecs SavingPlan.

func (s *EcsServiceV2) DescribeEcsSavingPlan(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("SavingPlan", id)), NotFoundMsg, ProviderERROR, fmt.Sprint(response["RequestId"]))
		}
...
func (s *EcsServiceV2) EcsSavingPlanStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeEcsSavingPlan(id)
		if err != nil {
...
// DescribeEcsSavingPlan >>> Encapsulated.
...
func (s *EcsServiceV2) DescribeEcsImageComponent(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("ImageComponent", id)), NotFoundMsg, ProviderERROR, fmt.Sprint(response["RequestId"]))
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *EcsServiceV2) DescribeEcsAutoSnapshotPolicy(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("AutoSnapshotPolicy", id)), NotFoundMsg, ProviderERROR, fmt.Sprint(response["RequestId"]))
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *EcsServiceV2) EcsAutoSnapshotPolicyStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
...
func (s *EcsServiceV2) DescribeEcsNetworkInterface(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("NetworkInterface", id)), NotFoundMsg, ProviderERROR, fmt.Sprint(response["RequestId"]))
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *EcsServiceV2) DescribeEcsSecurityGroup(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{}) {
			return object, WrapErrorf(Error(GetNotFoundMessage("SecurityGroup", id)), NotFoundMsg, ProviderERROR, fmt.Sprint(response["RequestId"]))
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
	...
	if err != nil {
		return object, WrapErrorf(err, FailedGetAttributeMsg, id, "$.SecurityGroups.SecurityGroup[*]", response)
	}
...
func (s *EcsServiceV2) DescribeDescribeSecurityGroupAttribute(id string) (object map[string]interface{}, err error) {
...
func (s *EcsServiceV2) DescribeDescribeSecurityGroupReferences(id string) (object map[string]interface{}, err error) {
...
func (s *EcsServiceV2) EcsSecurityGroupStateRefreshFunc(id string, field string, failStates []string) resource.StateRefreshFunc {
	return func() (interface{}, string, error) {
		object, err := s.DescribeEcsSecurityGroup(id)
		if err != nil {
			if NotFoundError(err) {
				return object, "", nil
			}
