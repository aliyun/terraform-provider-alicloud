...
// lintignore: AT001
func TestAccAliCloudRdsDBBackupPolicy_TEMP_enable_pitr_protection(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_db_backup_policy.default"
	serverFunc := func() interface{} {
		return &RdsService{testAccProvider.Meta().(*connectivity.AliyunClient)}
	...
	testAccCheck := rac.resourceAttrMapUpdateSet()
	name := "tf-testAccDBbackuppolicy"
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, resourceDBBackupPolicyMysqlCloudConfigDependence)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
// lintignore: AT001
func TestAccAliCloudRdsDBBackupPolicy_TEMP_enable_increment_data_backup(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_db_backup_policy.default"
	serverFunc := func() interface{} {
		return &RdsService{testAccProvider.Meta().(*connectivity.AliyunClient)}
	...
	testAccCheck := rac.resourceAttrMapUpdateSet()
	name := "tf-testAccDBbackuppolicy"
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, resourceDBBackupPolicyMysqlLocalSSDConfigDependence)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
func resourceDBBackupPolicyMysqlLocalSSDConfigDependence(name string) string {
	return fmt.Sprintf(`
variable "name" {
  default = "%s"
}
...
func resourceDBBackupPolicyMysqlCloudConfigDependence(name string) string {
	return fmt.Sprintf(`
variable "name" {
  default = "%s"
}
