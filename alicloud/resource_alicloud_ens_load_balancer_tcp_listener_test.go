...
var AliCloudEnsLoadBalancerTcpListenerMap = map[string]string{
	"backend_server_port":          CHECKSET,
	"description":                  CHECKSET,
	"eip_transmit":                 CHECKSET,
	"established_timeout":          CHECKSET,
	"health_check_connect_port":    CHECKSET,
	"health_check_connect_timeout": CHECKSET,
	"health_check_domain":          CHECKSET,
	"health_check_http_code":       CHECKSET,
	"health_check_interval":        CHECKSET,
	"health_check_type":            CHECKSET,
	"health_check_uri":             CHECKSET,
	"healthy_threshold":            CHECKSET,
	"listener_port":                CHECKSET,
	"load_balancer_id":             CHECKSET,
	"persistence_timeout":          CHECKSET,
	"protocol":                     CHECKSET,
	"scheduler":                    CHECKSET,
	"status":                       CHECKSET,
