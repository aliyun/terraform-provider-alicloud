...
// Case 2400
func TestAccAliCloudMessageServiceTopic_basic2400(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_message_service_topic.default"
	ra := resourceAttrInit(resourceId, AlicloudMessageServiceTopicMap2400)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
	...
	testAccConfig := resourceTestAccConfigFunc(resourceId, name, AlicloudMessageServiceTopicBasicDependence2400)
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
...
var AlicloudMessageServiceTopicMap2400 = map[string]string{
	"create_time":      CHECKSET,
	"max_message_size": "65536",
}

func AlicloudMessageServiceTopicBasicDependence2400(name string) string {
	return fmt.Sprintf(`
variable "name" {
    default = "%s"
}
...
// Case 2400  twin
func TestAccAliCloudMessageServiceTopic_basic2400_twin(t *testing.T) {
	var v map[string]interface{}
	resourceId := "alicloud_message_service_topic.default"
	ra := resourceAttrInit(resourceId, AlicloudMessageServiceTopicMap2400)
	rc := resourceCheckInitWithDescribeMethod(resourceId, &v, func() interface{} {
