...
func dataSourceAlicloudEnsNetworkRouteTablesRead(d *schema.ResourceData, meta interface{}) error {
	...
	for _, objectRaw := range objects {
		mapping := map[string]interface{}{
			"id":                             objectRaw["RouteTableId"],
			"associate_type":                 objectRaw["AssociateType"],
			"create_time":                    objectRaw["CreationTime"],
			"description":                    objectRaw["Description"],
			"is_default_gateway_route_table": objectRaw["IsDefaultGatewayRouteTable"],
			"network_id":                     objectRaw["NetworkId"],
			"route_table_id":                 objectRaw["RouteTableId"],
			"route_table_name":               objectRaw["RouteTableName"],
			"route_table_type":               objectRaw["Type"],
