...
- **New Resource:** `alicloud_sae_load_balancer_internet` [GH-4868]
- **New Resource:** `alicloud_ess_eci_scaling_configuration` [GH-4855]
- **New Data Source:** `alicloud_hbr_ots_snapshots` [GH-4861]

ENHANCEMENTS:

- resource/alicloud_ess_alb_server_group_attachment: support force_attach is false [GH-4824]
- resource/load_balancer_internet: update the field internet_slb_id from required to optional [GH-4871]
- resource/alicloud_r_kvstore: Filter out the security ip generated by the system [GH-4869]
- resource/alicloud_instance: Support field operator_type. [GH-4851]
- resource/alicloud_cs_autoscaling_config: Support scale_down_enabled and expander parameter [GH-4844]
- resource/alicloud_log_dashboard: update dashboard to support action in char_list [GH-4860]
- resource/alicloud_cen_transit_vbr_atachment: Enlarges the default timeout for creating, updateing and deleting [GH-4865]
- resource/alicloud_kvstore_instance: Added error retry code Task.Conflict [GH-4848]
- resource/alicloud_mse_cluster: Improves the throwing error message implementation while invoking the OpenAPI [GH-4846]
- datasource/alicloud_bastionhost_instances: Updates its dependence SDK [GH-4853]
- datasource/alicloud_sae_applications: Support new field oss_mount_details [GH-4858]	
- datasource/hbr_backup_jobs: add the field ots_detail && alicoud/hbr_backup_plan: add the field rule	
- testcase: Adds new unit test case for resource alicloud_dms_enterprise_user alicloud_dts_consumer_channel alicloud_dts_job_monitor_rule [GH-4821]
- testcase: Adds new unit test case for resource alicloud_eci_virtual_node alicloud_dts_synchronization_instance alicloud_eais_instance [GH-4822]
- testcase: Adds new unit test case for resource alicloud_eip_address alicloud_eipanycast_anycast_eip_address alicloud_ehpc_job_template [GH-4830]
- testcase: Adds new unit test case for resource alicloud_event_bridge_event_bus alicloud_event_bridge_event_source alicloud_ens_key_pair [GH-4839]
- testcase: Adds new unit test case for resource alicloud_event_bridge_service_linked_role alicloud_express_connect_physical_connection alicloud_express_connect_virtual_border_router [GH-4850]
- testcase: Improves the alicloud_common_bandwidth_attachment testcase [GH-4859]
- testcase: Adds new unit test case for resource alicloud_fnf_schedule alicloud_fnf_flow alicloud_fnf_execution [GH-4856]
- testcase: Adds new unit test case for resource alicloud_iot_device_group alicloud_imm_project alicloud_imp_app_template [GH-4867]
- testcase: Adds new unit test case for resource alicloud_hbr_oss_backup_plan alicloud_gpdb_account alicloud_hbr_ecs_backup_plan [GH-4863]
- testcases: Improves the alicloud_hbr_ecs_backup_plan testcases [GH-4870]
- GithubWorkFlow: pause the misspell workflow because of the different ownerships [GH-4864]

BUG FIXES:

- resource/alicloud_ess_alb_server_group_attachment: Fixes the resource not found error [GH-4872]
- resource/alicloud_cms_contact_group: Fixes the connection failed error; client: Fixes the SDK.CanNotResolveEndpoint error for CMS client and its resources [GH-4852]
- resource/alicloud_cms_alarm : Fixes the empty pointer error [GH-4862]
- resource/alicloud_elasticsearch_instance: fix the type convert error [GH-4845]
- testcase: Fixes cs kubernetes resource testcases [GH-4849]
