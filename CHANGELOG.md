...
- **New Resource:** `alicloud_privatelink_vpc_endpoint_connection` [GH-3145]
- **Data Source:** `alicloud_privatelink_vpc_endpoint_connections` [GH-3145]

IMPROVEMENTS:

- Feature/rds disk encryption for mysql [GH-3156]
- resource disk_attachment support import [GH-3151]
- Add NotFound Message for cms_alarm resource [GH-3148]
- resource/alicloud_fnf_flow: Add enumerate value for 'type' [GH-3146]
- update changelog [GH-3142]
- resource/zone_attachment:upgrade zone_attachment to teadsl sdk [GH-3125]
- rsource/alicloud_maxcompute_project: Generated by apispec [GH-3087]

BUG FIXES:

- datasource/fnf_flows,fnf_schedules: fix datasource [GH-3157]
- resource/alicloud_security_group_rule: Fix batch creation bug [GH-3149]
