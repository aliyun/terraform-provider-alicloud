...
- **错误码语义查证**(PR 涉及 retry 白名单 / `IsExpectedErrors` / 错误码补丁等) → 读 `.Codex/skills/aone-triage/references/aliyun-error-code-lookup.md`(跨 skill 复用,给定 product+code 出 HTTP/中英 message/官方 retry 建议/相邻错误码)。
