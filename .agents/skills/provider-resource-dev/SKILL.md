...
- 与 Terraform-客户需求池的客户主单双向关联;关联单不 claim(jarvis 无 tf_provider 池管理权),bookend 挂客户主单(claim/wrap done/release 都对客户主单做);无客户主单的 adhoc 场景按 loops/adhoc-intake.md 走。
