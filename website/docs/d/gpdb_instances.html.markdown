...
* `instances` - A list of Gpdb Db Instances. Each element contains the following attributes:
  ...
  * `db_instance_net_type` - (Available since v1.294.0) The network card type of the instance.
  ...
  * `expire_time` - (Available since v1.294.0) The time when the instance expires. The time is in the YYYY-MM-DDThh:mm:ssZ format.
  * `id` - The ID of the db Instance.
  * `instance_deploy_type` - (Available since v1.294.0) The deployment type of the instance.
  * `instance_network_type` - The network type of the instance.
  * `lock_mode` - (Available since v1.294.0) The lock mode of the instance.
  * `lock_reason` - (Available since v1.294.0) The reason why the instance is locked.
