...
* `storage_type` - (Optional) The DB instance storage space required by the user. Valid values: "cloud_ssd", "local_ssd", "cloud_essd", "cloud_essd2", "cloud_essd3"
* `db_instance_storage_type` - (Optional, Available in 1.134.0+) Same as `storage_type`.
