...
-> **DEPRECATED:**  This resource  has been deprecated from version `1.118.0`. Please use new resource [alicloud_adb_db_clusters](https://www.terraform.io/docs/providers/alicloud/r/adb_db_clusters.html).
