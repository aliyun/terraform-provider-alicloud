...
* `category` - (Optional, Available in 1.134.0+) DB Instance category. the value like [`Basic`, `HighAvailability`, `Finance`, `AlwaysOn`, `cluster`], [detail info](https://www.alibabacloud.com/help/doc-detail/69795.htm).
