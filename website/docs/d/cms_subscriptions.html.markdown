...
* `subscriptions` - A list of Subscription Entries.

### `subscriptions`

The subscriptions supports the following attributes:
...
### `subscriptions.filter_setting.conditions`
...
### `subscriptions.pushing_setting`

The pushing_setting supports the following attributes:
...
### `subscriptions.agent_config`

The agent_config supports the following attributes:
* `agent_uuid` - The UUID of the agent.
* `routes` - The list of notification routes.

### `subscriptions.agent_config.routes`
...
### `subscriptions.agent_config.routes.channels`
...
### `subscriptions.agent_config.routes.effect_time_range`
