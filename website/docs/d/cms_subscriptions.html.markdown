...
* `relation` - The relation between conditions.
...
* `alert_action_ids` - A list of alert action plan IDs.
* `restore_action_ids` - A list of restore action plan IDs.
* `template_uuid` - The template UUID.
* `response_plan_id` - The response plan ID.
