...
* `notify_strategies` - A list of Notify Strategy Entries.

### `notify_strategies`

The notify_strategies supports the following attributes:
...
### `notify_strategies.grouping_setting`

The grouping_setting supports the following attributes:
...
### `notify_strategies.routes`

The routes supports the following attributes:
...
### `notify_strategies.routes.channels`

The channels supports the following attributes:
* `channel_type` - The type of the channel.
* `receivers` - The list of receivers.
* `enabled_sub_channels` - The list of enabled sub channels.

### `notify_strategies.routes.effect_time_range`

The effect_time_range supports the following attributes:
...
### `notify_strategies.routes.filter_setting`

The filter_setting supports the following attributes:
...
### `notify_strategies.routes.filter_setting.conditions`

The conditions supports the following attributes:
* `field` - The field to filter.
* `op` - The filter operator.
* `value` - The filter value.

### `notify_strategies.custom_template_entries`

The custom_template_entries supports the following attributes:
