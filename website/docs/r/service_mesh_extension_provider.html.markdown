...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_service_mesh_extension_provider&spm=docs.r.service_mesh_extension_provider.example&intl_lang=EN_US)
