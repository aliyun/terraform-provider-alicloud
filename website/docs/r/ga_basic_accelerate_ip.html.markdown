...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ga_basic_accelerate_ip&spm=docs.r.ga_basic_accelerate_ip.example&intl_lang=EN_US)
