...
* `platform` - (Optional, Computed, Deprecated since v1.215.0) Operating system release. Default value: 'AliyunLinux '. Valid values: `CentOS`, `AliyunLinux`, `Windows`, `WindowsCore`.
...
* `security_group_id` - (Optional, ForceNew, Computed, Deprecated since v1.215.0) The security group ID of the node pool. Select one of 'security_group_ids 'and 'security_group_ids'. Use 'security_group_ids 'recommend'.
...
* `name` - (Deprecated since v1.215.0). Field 'name' has been deprecated from provider version 1.215.0. New field 'node_pool_name' instead.
...
* `max_unavailable` - (Optional, Deprecated since v1.215.0) Maximum number of unavailable nodes. Default value: 1. Value range:\[1,1000\].
* `surge` - (Optional, Deprecated since v1.215.0) Number of additional nodes. You have to specify one of surge, surge_percentage.
* `surge_percentage` - (Optional, Deprecated since v1.215.0) Proportion of additional nodes. You have to specify one of surge, surge_percentage.
...
* `eip_bandwidth` - (Optional, Deprecated since v1.215.0) Peak EIP bandwidth. Its valid value range [1~500] in Mbps. Default to `5`.
* `eip_internet_charge_type` - (Optional, Deprecated since v1.215.0) The EIP billing type. Default value: 'PayByBandwidth '. Valid values:
...
* `is_bond_eip` - (Optional, Deprecated since v1.215.0) Whether to bind EIP for an instance. Default: `false`.
