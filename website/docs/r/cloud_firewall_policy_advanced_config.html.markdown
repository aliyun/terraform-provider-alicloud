...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cloud_firewall_policy_advanced_config&spm=docs.r.cloud_firewall_policy_advanced_config.example&intl_lang=EN_US)
