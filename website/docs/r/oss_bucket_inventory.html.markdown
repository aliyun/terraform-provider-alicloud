...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_oss_bucket_inventory&exampleId=e3a72e6a-b1b7-0fef-57a4-009efbfc1470b9dde9dd&activeTab=example&spm=docs.r.oss_bucket_inventory.0.e3a72e6ab1&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_oss_bucket_inventory&spm=docs.r.oss_bucket_inventory.example&intl_lang=EN_US)
