...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ecs_launch_template&spm=docs.r.ecs_launch_template.example&intl_lang=EN_US)
