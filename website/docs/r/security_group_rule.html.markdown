...
* `description` - (Optional, ForcesNew, Available in 1.54.0+) The description of the security group rule. The description can be up to 1 to 512 characters in length. Defaults to null.
