...
* `babelfish_port` - (Optional, Available in 1.175.0+) The TDS port of the instance for which Babelfish is enabled.
...
* `babelfish_config` - (Optional, Available in 1.175.0+) The configuration of an ApsaraDB RDS for PostgreSQL instance for which Babelfish is enabled. (documented below).
