...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_maxcompute_project&exampleId=a07de83c-1f49-a380-178f-68bcb67b9ff370a8a067&activeTab=example&spm=docs.r.maxcompute_project.0.a07de83c1f&intl_lang=EN_US" target="_blank">
