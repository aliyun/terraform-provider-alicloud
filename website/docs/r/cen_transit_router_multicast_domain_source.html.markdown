...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cen_transit_router_multicast_domain_source&spm=docs.r.cen_transit_router_multicast_domain_source.example&intl_lang=EN_US)
