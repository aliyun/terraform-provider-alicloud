...
* `to_connect_vpc_ip_block` - (Optional, Available since v1.228.0) The additional IP block that the VPC integration instance can access. See [`to_connect_vpc_ip_block`](#to_connect_vpc_ip_block) below.
