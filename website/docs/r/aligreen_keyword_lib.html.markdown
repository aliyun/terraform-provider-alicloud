...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_aligreen_keyword_lib&spm=docs.r.aligreen_keyword_lib.example&intl_lang=EN_US)
