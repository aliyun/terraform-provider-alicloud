...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_eflo_invocation&spm=docs.r.eflo_invocation.example&intl_lang=EN_US)
