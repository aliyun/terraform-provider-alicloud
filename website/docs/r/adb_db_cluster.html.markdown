...
* `auto_renew_period` - (Optional) Auto-renewal period of an cluster, in the unit of the month. It is valid when pay_type is `PrePaid`. Valid values: `1`, `2`, `3`, `6`, `12`, `24`, `36`. Default to `1`.
...
* `db_cluster_class` - (Optional, ForceNew) The db cluster class.
* `db_cluster_version` - (Optional, ForceNew) The db cluster version.
...
* `pay_type` - (Optional, Computed, ForceNew) The payment type of the resource. Valid values: `PostPaid`, `PrePaid`.
* `payment_type` - (Optional, Computed, ForceNew) The payment type of the resource. Valid values: `PostPaid`, `PrePaid`. Default to `PostPaid`.
* `period` - (Optional, ForceNew) The duration that you will buy DB cluster (in month). It is valid when pay_type is `PrePaid`. Valid values: [1~9], 12, 24, 36. Default to 1.
