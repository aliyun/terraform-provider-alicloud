...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_rds_custom_deployment_set&spm=docs.r.rds_custom_deployment_set.example&intl_lang=EN_US)
