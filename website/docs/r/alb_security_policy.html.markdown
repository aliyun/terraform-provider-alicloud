...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_alb_security_policy&spm=docs.r.alb_security_policy.example&intl_lang=EN_US)
