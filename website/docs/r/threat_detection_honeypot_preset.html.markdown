...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_threat_detection_honeypot_preset&spm=docs.r.threat_detection_honeypot_preset.example&intl_lang=EN_US)
