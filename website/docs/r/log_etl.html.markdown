...
* `access_key_id` - (Optional, Sensitive, Available since v1.2610.0) Source logstore access key id.
...
* `access_key_secret` - (Optional, Sensitive, Available since v1.2610.0) Source logstore access key secret.
...
* `lang` - (Optional, Available since v1.2610.0) The language of the etl job.
...
* `datasets` - (Optional, Available since v1.2610.0) LogETL datasets.
