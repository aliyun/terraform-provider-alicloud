...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_esa_routine_route&spm=docs.r.esa_routine_route.example&intl_lang=EN_US)
