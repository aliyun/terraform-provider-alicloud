...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_dbfs_instance&spm=docs.r.dbfs_instance.example&intl_lang=EN_US)
