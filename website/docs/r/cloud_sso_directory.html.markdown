...
description: |-
  Provides a Alicloud Cloud S S O Directory resource.
---

# alicloud_cloud_sso_directory

Provides a Cloud S S O Directory resource.



For information about Cloud S S O Directory and how to use it, see [What is Directory](https://www.alibabacloud.com/help/en/cloudsso/latest/api-cloudsso-2021-05-15-createdirectory).
...
Cloud S S O Directory can be imported using the id, e.g.
