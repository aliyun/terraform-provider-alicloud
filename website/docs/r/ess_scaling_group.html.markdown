...
* `stop_instance_timeout` - (Optional, Available since v1.236.0) The period of time required by the ECS instance to enter the Stopped state. Unit: seconds. Valid values: 30 to 240.
