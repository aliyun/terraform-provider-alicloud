...
* `base_bandwidth` - (Required,ForceNew) Base defend bandwidth of the instance. Valid values: 20. The unit is Gbps.
* `bandwidth` - (Required,ForceNew) Elastic defend bandwidth of the instance. This value must be larger than the base defend bandwidth. Valid values: 51,101. The unit is Gbps.
