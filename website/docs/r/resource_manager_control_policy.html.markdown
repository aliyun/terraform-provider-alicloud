...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_resource_manager_control_policy&spm=docs.r.resource_manager_control_policy.example&intl_lang=EN_US)
