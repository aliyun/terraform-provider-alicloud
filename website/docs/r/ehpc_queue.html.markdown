...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_ehpc_queue&exampleId=6e2a1e3b-022d-af2b-ee96-214f2cf124f5b610a7bb&activeTab=example&spm=docs.r.ehpc_queue.0.6e2a1e3b02&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ehpc_queue&spm=docs.r.ehpc_queue.example&intl_lang=EN_US)
