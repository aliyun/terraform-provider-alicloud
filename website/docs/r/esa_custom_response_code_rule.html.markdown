...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_esa_custom_response_code_rule&exampleId=794dd1d7-57c6-5268-077b-526b808ad01f95e9909a&activeTab=example&spm=docs.r.esa_custom_response_code_rule.0.794dd1d757&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_esa_custom_response_code_rule&spm=docs.r.esa_custom_response_code_rule.example&intl_lang=EN_US)
