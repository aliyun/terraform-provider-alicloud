...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_config_aggregate_delivery&spm=docs.r.config_aggregate_delivery.example&intl_lang=EN_US)
