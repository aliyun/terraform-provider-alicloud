...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_ess_eci_scaling_configuration&exampleId=f5a86819-7225-c3f4-dc4a-46d2fc04c6f633222b83&activeTab=example&spm=docs.r.ess_eci_scaling_configuration.0.f5a8681972&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ess_eci_scaling_configuration&spm=docs.r.ess_eci_scaling_configuration.example&intl_lang=EN_US)
