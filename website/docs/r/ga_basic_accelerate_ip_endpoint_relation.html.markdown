...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ga_basic_accelerate_ip_endpoint_relation&spm=docs.r.ga_basic_accelerate_ip_endpoint_relation.example&intl_lang=EN_US)
