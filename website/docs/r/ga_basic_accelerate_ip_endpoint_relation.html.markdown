...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_ga_basic_accelerate_ip_endpoint_relation&exampleId=0cf2c574-ffe0-b728-603f-7a4558b608ec3d0b96a2&activeTab=example&spm=docs.r.ga_basic_accelerate_ip_endpoint_relation.0.0cf2c574ff&intl_lang=EN_US" target="_blank">
