...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_nlb_server_group_server_attachment&spm=docs.r.nlb_server_group_server_attachment.example&intl_lang=EN_US)
