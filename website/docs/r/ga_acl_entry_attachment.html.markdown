...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ga_acl_entry_attachment&spm=docs.r.ga_acl_entry_attachment.example&intl_lang=EN_US)
