...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_mongodb_backup&exampleId=e3d3dd53-feb3-46b6-594b-49d35c38bf0ef4aa2356&activeTab=example&spm=docs.r.mongodb_backup.0.e3d3dd53fe&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_mongodb_backup&spm=docs.r.mongodb_backup.example&intl_lang=EN_US)
