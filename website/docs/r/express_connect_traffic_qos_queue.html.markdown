...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_express_connect_traffic_qos_queue&spm=docs.r.express_connect_traffic_qos_queue.example&intl_lang=EN_US)
