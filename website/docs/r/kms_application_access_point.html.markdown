...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_kms_application_access_point&spm=docs.r.kms_application_access_point.example&intl_lang=EN_US)
