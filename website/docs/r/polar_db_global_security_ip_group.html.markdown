...
subcategory: "PolarDB"
layout: "alicloud"
page_title: "Alicloud: alicloud_polar_db_global_security_ip_group"
description: |-
  Provides a Alicloud Polar Db Global Security Ip Group resource.
---

# alicloud_polar_db_global_security_ip_group

Provides a Polar Db Global Security Ip Group resource.

Global Security IP Group.

For information about Polar Db Global Security Ip Group and how to use it, see [What is Global Security Ip Group](https://next.api.alibabacloud.com/document/polardb/2017-08-01/CreateGlobalSecurityIPGroup).
...
resource "alicloud_polar_db_global_security_ip_group" "default" {
...
Polar Db Global Security Ip Group can be imported using the id, e.g.

```shell
$ terraform import alicloud_polar_db_global_security_ip_group.example <id>
```