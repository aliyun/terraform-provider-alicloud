...
* `master_disk_performance_level` - (Optional, ForceNew, Available in 1.119.1+) Master node system disk performance level. When `master_disk_category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
* `master_disk_snapshot_policy_id` - (Optional, ForceNew, Available in 1.119.1+) Master node system disk auto snapshot policy.
...
* `worker_data_disks` - (Optional, Available in 1.91.0+) The data disk configurations of worker nodes, such as the disk type and disk size.
  ...
  * `auto_snapshot_policy_id` - (Optional, Available in 1.119.1+) Worker node data disk auto snapshot policy.
...
* `worker_disk_performance_level` - (Optional, Available in 1.119.1+) Worker node system disk performance level, when `worker_disk_category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
* `worker_disk_snapshot_policy_id` - (Optional, Available in 1.119.1+) Worker node system disk auto snapshot policy.
