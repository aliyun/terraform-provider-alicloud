...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_data_works_di_alarm_rule&spm=docs.r.data_works_di_alarm_rule.example&intl_lang=EN_US)
