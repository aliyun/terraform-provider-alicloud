...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_oss_bucket_data_redundancy_transition&spm=docs.r.oss_bucket_data_redundancy_transition.example&intl_lang=EN_US)
