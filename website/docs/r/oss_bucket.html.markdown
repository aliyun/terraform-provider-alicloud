...
* `redundancy_type` - (Optional, ForceNew, Available in 1.89.0) The [redundancy type](https://www.alibabacloud.com/help/doc-detail/90589.htm) to enable. Can be "LRS", and "ZRS". Defaults to "LRS".
