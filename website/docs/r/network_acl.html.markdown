...
* `entry_type` - (Optional, Available since v1.220.0) The route entry type. Value
  - `custom`: custom rule
  - `system`: system rules
...
* `network_acl_entry_id` - (Optional, ForceNew, Available since v1.244.0) Network acl entry id.
