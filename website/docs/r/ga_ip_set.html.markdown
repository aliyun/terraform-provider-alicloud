...
* `ip_version` - (Optional, ForceNew) The IP protocol used by the GA instance. Default value: `IPv4`. Valid values: `IPv4`, `IPv6`, `DUAL_STACK`. **NOTE:** From version 1.219.1, `ip_version` can be set to `DUAL_STACK`.
