...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ram_group_policy_attachment&spm=docs.r.ram_group_policy_attachment.example&intl_lang=EN_US)
