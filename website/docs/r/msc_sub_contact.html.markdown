...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_msc_sub_contact&spm=docs.r.msc_sub_contact.example&intl_lang=EN_US)
