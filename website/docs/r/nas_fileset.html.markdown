...
* `deletion_protection` - (Optional, Computed, Available since v1.265.0) The instance release protection attribute, which specifies whether the instance can be released through the console or API( DeleteFileset).
