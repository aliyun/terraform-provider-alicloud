...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_esa_http_incoming_response_header_modification_rule&exampleId=ba33e939-2c7f-91ac-fc88-b058fc2cfd7707a8ae3f&activeTab=example&spm=docs.r.esa_http_incoming_response_header_modification_rule.0.ba33e9392c&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_esa_http_incoming_response_header_modification_rule&spm=docs.r.esa_http_incoming_response_header_modification_rule.example&intl_lang=EN_US)
