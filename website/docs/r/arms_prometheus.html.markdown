...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_arms_prometheus&spm=docs.r.arms_prometheus.example&intl_lang=EN_US)
