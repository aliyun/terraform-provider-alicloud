...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_star_rocks_instance&spm=docs.r.star_rocks_instance.example&intl_lang=EN_US)
