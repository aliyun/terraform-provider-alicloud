...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_oss_bucket_public_access_block&spm=docs.r.oss_bucket_public_access_block.example&intl_lang=EN_US)
