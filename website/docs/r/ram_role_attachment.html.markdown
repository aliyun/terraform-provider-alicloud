...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_ram_role_attachment&exampleId=6e027f60-510b-f8b9-d172-8eee088a5368b7a79508&activeTab=example&spm=docs.r.ram_role_attachment.0.6e027f6051&intl_lang=EN_US" target="_blank">
