...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_apig_source&exampleId=c9019192-a8a1-ed82-cfba-527da927146bff88570a&activeTab=example&spm=docs.r.apig_source.0.c9019192a8&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_apig_source&spm=docs.r.apig_source.example&intl_lang=EN_US)
