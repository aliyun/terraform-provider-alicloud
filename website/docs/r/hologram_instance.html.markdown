...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_hologram_instance&spm=docs.r.hologram_instance.example&intl_lang=EN_US)
