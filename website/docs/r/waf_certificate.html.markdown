...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_waf_certificate&spm=docs.r.waf_certificate.example&intl_lang=EN_US)
