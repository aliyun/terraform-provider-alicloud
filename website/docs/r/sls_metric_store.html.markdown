...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_sls_metric_store&exampleId=9a5fc871-39c1-f072-c24f-ad5ea2d8fc7144e454ec&activeTab=example&spm=docs.r.sls_metric_store.0.9a5fc87139&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_sls_metric_store&spm=docs.r.sls_metric_store.example&intl_lang=EN_US)
