...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_ecd_desktop_group&exampleId=0f11f287-fc41-0b65-f2af-0f7147ed28a3254d424c&activeTab=example&spm=docs.r.ecd_desktop_group.0.0f11f287fc&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ecd_desktop_group&spm=docs.r.ecd_desktop_group.example&intl_lang=EN_US)
...
* `end_user_ids` - (Optional, List) The list of IDs of the end users authorized to use the desktop group. Reordering the IDs does not change the authorized users, and the configured order is kept after apply.
...
* `pay_type` - (Optional, Computed) The billing method of the desktop group. Valid values: `PostPaid`. If it is not set, the desktop group is created with the `PostPaid` billing method. **Note: The parameter is immutable after resource creation.**
