...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_vpc_ipv4_cidr_block&spm=docs.r.vpc_ipv4_cidr_block.example&intl_lang=EN_US)
