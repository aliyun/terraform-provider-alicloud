...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_dfs_mount_point&spm=docs.r.dfs_mount_point.example&intl_lang=EN_US)
