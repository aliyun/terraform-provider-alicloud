...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ga_basic_accelerator&spm=docs.r.ga_basic_accelerator.example&intl_lang=EN_US)
