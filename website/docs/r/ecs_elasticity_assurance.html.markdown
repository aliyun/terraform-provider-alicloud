...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ecs_elasticity_assurance&spm=docs.r.ecs_elasticity_assurance.example&intl_lang=EN_US)
