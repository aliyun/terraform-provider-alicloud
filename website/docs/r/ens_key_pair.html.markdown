...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ens_key_pair&spm=docs.r.ens_key_pair.example&intl_lang=EN_US)
