...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_gwlb_load_balancer&spm=docs.r.gwlb_load_balancer.example&intl_lang=EN_US)
