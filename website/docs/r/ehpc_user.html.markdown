...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_ehpc_user&exampleId=606335a2-fda8-bbec-9b9e-190518ab7883c4a0e597&activeTab=example&spm=docs.r.ehpc_user.0.606335a2fd&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ehpc_user&spm=docs.r.ehpc_user.example&intl_lang=EN_US)
