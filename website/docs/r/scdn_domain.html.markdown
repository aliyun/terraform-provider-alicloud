...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_scdn_domain&spm=docs.r.scdn_domain.example&intl_lang=EN_US)
