...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cloud_monitor_service_basic_public&spm=docs.r.cloud_monitor_service_basic_public.example&intl_lang=EN_US)
