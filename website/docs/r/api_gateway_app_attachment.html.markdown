...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_api_gateway_app_attachment&spm=docs.r.api_gateway_app_attachment.example&intl_lang=EN_US)
