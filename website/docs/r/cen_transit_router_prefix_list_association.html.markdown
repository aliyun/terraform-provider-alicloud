...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cen_transit_router_prefix_list_association&spm=docs.r.cen_transit_router_prefix_list_association.example&intl_lang=EN_US)
