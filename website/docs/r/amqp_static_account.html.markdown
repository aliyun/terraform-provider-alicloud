...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_amqp_static_account&spm=docs.r.amqp_static_account.example&intl_lang=EN_US)
