...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_common_bandwidth_package_attachment&exampleId=bf59f4a7-ea27-1130-efdb-dc000fab2c0587d5a448&activeTab=example&spm=docs.r.common_bandwidth_package_attachment.0.bf59f4a7ea&intl_lang=EN_US" target="_blank">
