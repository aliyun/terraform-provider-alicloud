...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cr_chart_namespace&spm=docs.r.cr_chart_namespace.example&intl_lang=EN_US)
