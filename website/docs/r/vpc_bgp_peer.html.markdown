...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_vpc_bgp_peer&exampleId=9347c15d-7dfc-00dd-f5c0-0b26b2c8e9f9cbea2ca6&activeTab=example&spm=docs.r.vpc_bgp_peer.0.9347c15d7d&intl_lang=EN_US" target="_blank">
