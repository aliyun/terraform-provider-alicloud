...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_vpc_bgp_network&spm=docs.r.vpc_bgp_network.example&intl_lang=EN_US)
