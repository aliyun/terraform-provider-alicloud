...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cloudauth_face_config&spm=docs.r.cloudauth_face_config.example&intl_lang=EN_US)
