...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_esa_rewrite_url_rule&spm=docs.r.esa_rewrite_url_rule.example&intl_lang=EN_US)
