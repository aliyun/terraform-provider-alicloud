...
* `group_name` - (Removed since v1.210.0) The group name. **NOTE:** Field `group_name` has been removed from provider version 1.210.0.
...
* `phoenix_node_count` - (Removed since v1.210.0) The count of phoenix. **NOTE:** Field `phoenix_node_count` has been removed from provider version 1.210.0.
* `phoenix_node_specification` - (Removed since v1.210.0) The specification of phoenix. **NOTE:** Field `phoenix_node_specification` has been removed from provider version 1.210.0.
...
* `stream_engine_node_count` - (Optional, Int, Available since v1.210.0) The number of LindormStream nodes in the instance.
* `stream_engine_specification` - (Optional, Available since v1.210.0) The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
...
* `enabled_stream_engine` - (Available since v1.210.0) Whether to enable streaming engine.
