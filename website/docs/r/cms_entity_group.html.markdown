...
* `tags` - (Optional) A list of tag rules. See [`tags`](#entity_rules-tags) below.
* `labels` - (Optional) A list of label rules. See [`labels`](#entity_rules-labels) below.
* `annotations` - (Optional) A list of annotation rules. See [`annotations`](#entity_rules-annotations) below.
* `ip_match_rule` - (Optional) The IP match rule. A list with at most one element. See [`ip_match_rule`](#entity_rules-ip_match_rule) below.
* `instance_ids` - (Optional) A list of instance IDs.
* `field_rules` - (Optional) A list of field rules. See [`field_rules`](#entity_rules-field_rules) below.
