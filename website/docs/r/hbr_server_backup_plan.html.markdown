...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_hbr_server_backup_plan&spm=docs.r.hbr_server_backup_plan.example&intl_lang=EN_US)
