...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_oss_bucket_replication&exampleId=0092cd3d-7a08-7a78-3b1a-3a75118268b58a3703d4&activeTab=example&spm=docs.r.oss_bucket_replication.0.0092cd3d7a&intl_lang=EN_US" target="_blank">
