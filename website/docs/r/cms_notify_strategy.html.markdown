...
* `grouping_setting` - (Optional, List) The grouping setting of the notify strategy. See [`grouping_setting`](#grouping_setting) below.
* `routes` - (Optional, List) The list of notification routes. See [`routes`](#routes) below.
