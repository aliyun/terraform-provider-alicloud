...
description: |-
  Provides a Alicloud ESA Waf Rule Set resource.
---

# alicloud_esa_waf_ruleset

Provides a ESA Waf Rule Set resource.

waf rule set.

For information about ESA Waf Rule Set and how to use it, see [What is Waf Rule Set](https://next.api.alibabacloud.com/document/ESA/2024-09-10/CreateWafRuleset).
...
* `create` - (Defaults to 5 mins) Used when create the Waf Rule Set.
* `delete` - (Defaults to 5 mins) Used when delete the Waf Rule Set.
* `update` - (Defaults to 5 mins) Used when update the Waf Rule Set.

## Import

ESA Waf Rule Set can be imported using the id, e.g.
