...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_cms_event_notify_policy&exampleId=f0ca1929-dae4-c361-084d-c69704c6c0d9990d13a3&activeTab=example&spm=docs.r.cms_event_notify_policy.0.f0ca1929da&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cms_event_notify_policy&spm=docs.r.cms_event_notify_policy.example&intl_lang=EN_US)
