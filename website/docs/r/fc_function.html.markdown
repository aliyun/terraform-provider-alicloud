...
* `code_checksum` - (Optional, Available in 1.59.0+) The checksum (crc64) of the function code.The value can be generated by data source alicloud_file_crc64_checksum.
