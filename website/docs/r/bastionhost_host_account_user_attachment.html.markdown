...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_bastionhost_host_account_user_attachment&exampleId=9f1f5bdd-f791-1a5d-4047-3c4323516a98396a0ca0&activeTab=example&spm=docs.r.bastionhost_host_account_user_attachment.0.9f1f5bddf7&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_bastionhost_host_account_user_attachment&spm=docs.r.bastionhost_host_account_user_attachment.example&intl_lang=EN_US)
