...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_gpdb_external_data_service&spm=docs.r.gpdb_external_data_service.example&intl_lang=EN_US)
