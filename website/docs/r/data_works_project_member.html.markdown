...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_data_works_project_member&spm=docs.r.data_works_project_member.example&intl_lang=EN_US)
