...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cloud_sso_user_provisioning&spm=docs.r.cloud_sso_user_provisioning.example&intl_lang=EN_US)
