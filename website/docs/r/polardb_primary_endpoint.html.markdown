...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_polardb_primary_endpoint&spm=docs.r.polardb_primary_endpoint.example&intl_lang=EN_US)
