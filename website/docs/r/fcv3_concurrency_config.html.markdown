...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_fcv3_concurrency_config&exampleId=f059095b-a111-2324-f857-ec6f346762f321ec3f49&activeTab=example&spm=docs.r.fcv3_concurrency_config.0.f059095ba1&intl_lang=EN_US" target="_blank">
...
* `reserved_concurrency` - (Optional) Reserved Concurrency. Functions reserve a part of account concurrency. Other functions cannot use this part of concurrency. Reserved concurrency includes the total concurrency of Reserved Instances and As-You-go instances.
