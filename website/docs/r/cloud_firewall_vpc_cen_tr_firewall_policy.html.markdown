...
* `dest_candidate_list` - (Optional, List) List of Secondary Traffic Redirection instances. See [`dest_candidate_list`](#dest_candidate_list) below.
...
* `src_candidate_list` - (Required, List) List of Primary Traffic Redirection instances. See [`src_candidate_list`](#src_candidate_list) below.
