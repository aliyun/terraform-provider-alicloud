...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_ros_stack&exampleId=aa17e5cf-fef0-e575-c30a-d8ae978bcb35be89d3e1&activeTab=example&spm=docs.r.ros_stack.0.aa17e5cffe&intl_lang=EN_US" target="_blank">
