...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_esa_origin_protection&spm=docs.r.esa_origin_protection.example&intl_lang=EN_US)
