...
* `version` - (Optional, Available since 1.96.0) Desired Kubernetes version. If you do not specify a value, the latest available version at resource creation is used.
