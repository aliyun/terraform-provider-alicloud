...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ram_saml_provider&spm=docs.r.ram_saml_provider.example&intl_lang=EN_US)
