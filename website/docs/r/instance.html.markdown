...
* `instance_metadata_tags` - (Optional, Available since v1.290.0) Specifies whether to expose the tags of the instance in the instance metadata. Valid values: `enabled`, `disabled`. Default value: `disabled`.
