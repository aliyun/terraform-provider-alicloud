...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cloud_firewall_vpc_firewall&spm=docs.r.cloud_firewall_vpc_firewall.example&intl_lang=EN_US)
