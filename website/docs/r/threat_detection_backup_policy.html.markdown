...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_threat_detection_backup_policy&spm=docs.r.threat_detection_backup_policy.example&intl_lang=EN_US)
