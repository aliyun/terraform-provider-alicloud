...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_direct_mail_receivers&spm=docs.r.direct_mail_receivers.example&intl_lang=EN_US)
