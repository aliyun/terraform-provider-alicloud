...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_mongodb_sharding_instance&exampleId=874d56f5-a570-28e3-0452-da5798a4de86d90c0f58&activeTab=example&spm=docs.r.mongodb_sharding_instance.0.874d56f5a5&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_mongodb_sharding_instance&spm=docs.r.mongodb_sharding_instance.example&intl_lang=EN_US)
