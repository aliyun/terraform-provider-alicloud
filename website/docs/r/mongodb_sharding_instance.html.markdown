...
* `parameters` - (Optional, Set, Available since v1.267.0) Set of parameters needs to be set after mongodb instance was launched. See [`parameters`](#parameters) below.
