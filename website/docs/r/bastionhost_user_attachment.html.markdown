...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_bastionhost_user_attachment&spm=docs.r.bastionhost_user_attachment.example&intl_lang=EN_US)
