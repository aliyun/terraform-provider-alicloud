...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cen_transit_route_table_aggregation&spm=docs.r.cen_transit_route_table_aggregation.example&intl_lang=EN_US)
