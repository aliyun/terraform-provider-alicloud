...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_esa_redirect_rule&spm=docs.r.esa_redirect_rule.example&intl_lang=EN_US)
