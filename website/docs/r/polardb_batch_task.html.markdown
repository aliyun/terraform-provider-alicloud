...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_polardb_batch_task&exampleId=cdb5ed76-8fb5-5d38-a6e9-55fcf5fd43600e60f195&activeTab=example&spm=docs.r.polardb_batch_task.0.cdb5ed768f&intl_lang=EN_US" target="_blank">
...
* `instance_ids` - (Required, ForceNew) A list of PolarDB application IDs to which the task will be applied.
...
* `region_id` - (Optional, ForceNew) The region ID where the PolarDB applications are located. If not specified, the provider's region is used.
