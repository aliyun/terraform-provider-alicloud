...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_gpdb_db_extension&exampleId=5c9841ec-0608-ceea-c4f2-8fa0a28c6d11e064cd0e&activeTab=example&spm=docs.r.gpdb_db_extension.0.5c9841ec06&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_gpdb_db_extension&spm=docs.r.gpdb_db_extension.example&intl_lang=EN_US)
