...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_privatelink_vpc_endpoint_service&spm=docs.r.privatelink_vpc_endpoint_service.example&intl_lang=EN_US)
