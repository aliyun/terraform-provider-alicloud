...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_dns_record&exampleId=ad8807c0-d0c9-0bb5-0f18-223ffffb8aa6a489636c&activeTab=example&spm=docs.r.dns_record.0.ad8807c0d0&intl_lang=EN_US" target="_blank">
