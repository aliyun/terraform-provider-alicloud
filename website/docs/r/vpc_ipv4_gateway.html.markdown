...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_vpc_ipv4_gateway&spm=docs.r.vpc_ipv4_gateway.example&intl_lang=EN_US)
