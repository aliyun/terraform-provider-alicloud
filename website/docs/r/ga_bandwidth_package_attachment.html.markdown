...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/api-tools/terraform?resource=alicloud_ga_bandwidth_package_attachment&exampleId=fdd25e31-816e-745a-9fdd-10fe6fdaea88470b76d6&activeTab=example&spm=docs.r.ga_bandwidth_package_attachment.0.fdd25e3181&intl_lang=EN_US" target="_blank">
