...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_cloud_firewall_vpc_firewall_control_policy_order&exampleId=1d7fea9f-1658-b079-a96c-077faf875b17d987a475&activeTab=example&spm=docs.r.cloud_firewall_vpc_firewall_control_policy_order.0.1d7fea9f16&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_cloud_firewall_vpc_firewall_control_policy_order&spm=docs.r.cloud_firewall_vpc_firewall_control_policy_order.example&intl_lang=EN_US)
