...
For information about Resource Manager Handshake Acceptance and how to use it, see [What is Handshake](https://www.alibabacloud.com/help/en/doc-detail/135287.htm) and the [AcceptHandshake](https://www.alibabacloud.com/help/en/resource-management/developer-reference/api-resourcemanager-2020-03-31-accepthandshake) API.
...
* `handshake_id` - (Required, ForceNew) The ID of the invitation (handshake) to accept.
...
* `status` - The status of the invitation. After acceptance the status is `Accepted`.
