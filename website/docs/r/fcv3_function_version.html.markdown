...
description: |-
  Provides a Alicloud FC3 Function Version resource.
---

# alicloud_fcv3_function_version

Provides a FC3 Function Version resource.

Version of the function.

For information about FC3 Function Version and how to use it, see [What is Function Version](https://www.alibabacloud.com/help/en/functioncompute/developer-reference/api-fc-2023-03-30-listfunctionversions).
...
FC3 Function Version can be imported using the id, e.g.
