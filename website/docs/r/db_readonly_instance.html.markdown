...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_db_readonly_instance&spm=docs.r.db_readonly_instance.example&intl_lang=EN_US)
