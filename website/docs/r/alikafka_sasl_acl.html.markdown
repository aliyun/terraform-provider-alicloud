...
* `acl_resource_type` - (Required, ForceNew) Resource type for this acl. The resource type can only be "Topic", "Group". Since version 1.246.0, the resource type support "Cluster" and "TransactionalId".
