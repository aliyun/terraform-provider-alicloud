...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_bastionhost_host_account_user_group_attachment&exampleId=dddf3f96-d100-b41f-bde8-c1a6537843ed66909825&activeTab=example&spm=docs.r.bastionhost_host_account_user_group_attachment.0.dddf3f96d1&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_bastionhost_host_account_user_group_attachment&spm=docs.r.bastionhost_host_account_user_group_attachment.example&intl_lang=EN_US)
