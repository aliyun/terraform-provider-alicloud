...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_apig_plugin_class&exampleId=50e6a6c2-6fb6-7cd3-69db-c2dc9247d00abc843769&activeTab=example&spm=docs.r.apig_plugin_class.0.50e6a6c26f&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_apig_plugin_class&spm=docs.r.apig_plugin_class.example&intl_lang=EN_US)
