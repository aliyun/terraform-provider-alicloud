...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?resource=alicloud_oss_bucket_server_side_encryption&exampleId=a0f9f15b-24be-599e-b9d8-fd8fb8855ac999710065&activeTab=example&spm=docs.r.oss_bucket_server_side_encryption.0.a0f9f15b24&intl_lang=EN_US" target="_blank">
...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_oss_bucket_server_side_encryption&spm=docs.r.oss_bucket_server_side_encryption.example&intl_lang=EN_US)
