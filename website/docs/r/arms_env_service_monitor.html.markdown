...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_arms_env_service_monitor&spm=docs.r.arms_env_service_monitor.example&intl_lang=EN_US)
