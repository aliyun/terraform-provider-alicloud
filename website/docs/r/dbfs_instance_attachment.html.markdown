...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_dbfs_instance_attachment&spm=docs.r.dbfs_instance_attachment.example&intl_lang=EN_US)
