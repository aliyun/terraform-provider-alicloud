...
macarm:
	GOOS=darwin GOARCH=arm64 go build -o bin/terraform-provider-alicloud_v1.1.0
	cp bin/terraform-provider-alicloud_v1.1.0 ~/.terraform.d/plugins/registry.terraform.io/aliyun/alicloud/1.1.0/darwin_arm64/
	mv bin/terraform-provider-alicloud_v1.1.0 ~/.terraform.d/plugins/registry.terraform.io/hashicorp/alicloud/1.1.0/darwin_arm64/
