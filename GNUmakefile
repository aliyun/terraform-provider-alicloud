...
.PHONY: build test testacc test-resource test-resource-debug minimal-test-set vet fmt fmtcheck errcheck test-compile website website-test commit ci-check
